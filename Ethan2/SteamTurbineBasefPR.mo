within Ethan2;
model SteamTurbineBasefPR "Steam Turbine w/Fixed PR"
  ...
  //stdola incorporation
  parameter Real eta_iso_nom=0.92 "Nominal isentropic efficiency";
  Modelica.SIunits.Area Kt "Kt coefficient of Stodola's law";
  ...
  ThermoPower3.Water.FlangeA inlet(redeclare package Medium = Medium, m_flow(min=
  ...
  ThermoPower3.Water.FlangeB outlet(redeclare package Medium = Medium, m_flow(max=
