within Ethan2;
model AnnularFlow1D2phChen
  "2 DHT port 1-dimensional fluid flow model for 2-phase boiling flow (finite volumes, 2-phase, Chen correlation)"
...
equation
  ...
  wall1.gamma = gamma + gamma_corr_left + gamma_corr_right
