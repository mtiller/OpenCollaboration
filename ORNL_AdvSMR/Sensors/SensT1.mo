...
model SensT1 "Temperature sensor for water/steam flows, single port"
  ...
  extends ORNL_AdvSMR.Icons.Water.SensP;

  replaceable package Medium = ORNL_AdvSMR.Media.Fluids.Na constrainedby
    Modelica.Media.Interfaces.PartialMedium "Port medium model";
  ...
  ORNL_AdvSMR.Interfaces.FlangeA flange(redeclare package Medium = Medium,
      m_flow(min=0)) annotation (Placement(transformation(extent={{-20,-60},{20,
            -20}}, rotation=0)));
