...
partial package KFZrF4_base "KFZrF4 base properties class"
...
redeclare function density_ph
  ...
  algorithm
  d := (3416 - 0.887*h/2380)*(1 + 5.9361e-11*p);
  end density_ph;
...
redeclare function extends thermalConductivity "Thermal conductivity of flibe"
  ...
  lambda := 0.0005*state.T + 32/33.0126 - 0.34
    "Ignatiev & Kholkov correlation for flibe; only a function of temperature (K) (Sacit - Feb. 9)";
