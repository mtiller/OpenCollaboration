within ORNL_AdvSMR.SmAHTR.Simulators;
model SteamPlant_Sim1_dp
  ...
  ThermoPower3.Gas.SourceW sourceGas(
    ...
    w0=585.5,
    T=884.65) annotation (Placement(transformation(extent={{-168,90},{-132,
            110}}, rotation=0)));
  Modelica.Blocks.Sources.Ramp ramp(
    height=-50,
    duration=500,
    offset=585.5,
    startTime=4000) annotation (Placement(transformation(extent={{-190,
            120},{-170,140}}, rotation=0)));
public
  ...
  ThermoPower3.PowerPlants.HRSG.Examples.HRSG_3LRh hRSG(
    ...
    drums(
      ...
      fluidLPNomPressure=604700)) annotation (Placement(transformation(
          extent={{-110,60},{-10,160}}, rotation=0)));
public
...
public
  ThermoPower3.PowerPlants.HRSG.Control.levelsControl levelsControl(
    ...
    CSmax_levelLP=2400) annotation (Placement(transformation(extent={{60,
            120},{120,180}}, rotation=0)));
  ThermoPower3.Gas.SinkP sinkGas(redeclare package Medium = FlueGasMedium,
      T=362.309) annotation (Placement(transformation(extent={{30,90},{50,
            110}}, rotation=0)));
public
  Modelica.Blocks.Sources.Ramp valveHP_com(
    height=0,
    offset=1,
    duration=2) annotation (Placement(transformation(extent={{180,90},{
            160,110}}, rotation=0)));
  Modelica.Blocks.Sources.Ramp valveIP_com(
    height=0,
    offset=1,
    duration=2) annotation (Placement(transformation(extent={{180,50},{
            160,70}}, rotation=0)));
  Modelica.Blocks.Sources.Ramp valveLP_com(
    height=0,
    offset=1,
    duration=2) annotation (Placement(transformation(extent={{180,10},{
            160,30}}, rotation=0)));
