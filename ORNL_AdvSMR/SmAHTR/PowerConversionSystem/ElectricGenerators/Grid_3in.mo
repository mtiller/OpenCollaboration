...
model Grid_3in "Ideal grid with finite droop and three inlet"
  ...
  ThermoPower3.Electrical.PowerConnection connection_C annotation (
      Placement(transformation(extent={{-100,-94},{-72,-66}}, rotation=
            0)));
equation
  ...
  annotation (Diagram(graphics), Icon(graphics={Line(points={{18,-16},{
          2,-38}}, color={0,0,0}),Line(points={{-72,-80},{-20,-48}},
          color={0,0,0}),Ellipse(
                  extent={{100,-68},{-40,68}},
                  lineColor={0,0,0},
                  lineThickness=0.5,
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),Line(points={{-72,0},{
          ...
          Ellipse(extent={{-8,2},{-2,-4}},
                  ...
                  lineColor={0,0,0},
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),Line(points={{-72,80},
          {-26,40}}, color={0,0,0})}));
end Grid_3in;
