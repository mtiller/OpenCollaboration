...
partial model GasTurbineSimplified
  ...
  ThermoPower3.Gas.FlangeB flueGasOut(redeclare package Medium =
  ...
  annotation (Diagram(graphics), Icon(graphics={Rectangle(
                    ...
                    points={{-20,18},{-24,24},{-24,64},{-20,64},{-20,
            18}},   lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    ...
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
                    points={{80,60},{76,56},{76,82},{100,82},{100,78},
            {80,78},{80,60}},
                    lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
                    points={{-80,70},{-20,30},{-20,-30},{-80,-70},{-80,
            70}},   lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
