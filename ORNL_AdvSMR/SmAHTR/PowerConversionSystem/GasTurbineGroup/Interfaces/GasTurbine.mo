within ORNL_AdvSMR.SmAHTR.PowerConversionSystem.GasTurbineGroup.Interfaces;
partial model GasTurbine "Base class for Gas Turbine"
  ...
  replaceable package AirMedium = Media.Fluids.Air constrainedby
    Modelica.Media.Interfaces.PartialMedium;
  replaceable package FuelMedium = ThermoPower3.Media.NaturalGas
    constrainedby Modelica.Media.Interfaces.PartialMedium;
  ThermoPower3.Gas.FlangeA FuelInlet(redeclare package Medium =
        FuelMedium) annotation (Placement(transformation(extent={{-20,
            180},{20,220}}, rotation=0)));
  ThermoPower3.Gas.FlangeA AirInlet(redeclare package Medium =
        AirMedium) annotation (Placement(transformation(extent={{-220,
            140},{-180,180}}, rotation=0)));
  ThermoPower3.Gas.FlangeB FlueGasOutlet(redeclare package Medium =
        FlueGasMedium) annotation (Placement(transformation(extent={{
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
                    ...
                    points={{-30,30},{-40,30},{-40,120},{-30,120},{-30,
            30}},   lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    ...
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
                    points={{-130,112},{-120,106},{-120,166},{-200,
            166},{-200,154},{-130,154},{-130,112}},
                    lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
                    points={{130,112},{120,108},{120,166},{200,166},{
            200,154},{130,154},{130,112}},
                    lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
                    points={{-130,120},{-30,40},{-30,-40},{-130,-120},
            {-130,120}},
                    lineColor={0,0,0},
                    fillPattern=FillPattern.Sphere,
                    fillColor={170,170,255}),Polygon(
