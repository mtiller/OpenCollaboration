...
partial model ST_2L "Base class for Steam Turbine with two pressure levels"
  ...
  parameter Modelica.SIunits.MassFlowRate LPT_wstart=
      steamLPNomFlowRate + steamHPNomFlowRate "Mass flow rate start value"
    annotation (Dialog(tab="Initialization", group="LP Turbine"));
  ...
  ThermoPower3.Water.FlangeB LPT_Out(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{40,
            -220},{80,-180}}, rotation=0)));
  ...
  annotation (Icon(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          color={0,0,255}),Line(points={{60,-90},{60,-192}}, color={0,
          0,255}),Polygon(
