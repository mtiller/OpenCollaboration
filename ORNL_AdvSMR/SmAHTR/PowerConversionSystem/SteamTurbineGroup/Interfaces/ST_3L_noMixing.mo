...
partial model ST_3L_noMixing
  ...
  parameter Modelica.SIunits.MassFlowRate LPT_wstart=
      steamLPNomFlowRate + steamIPNomFlowRate + steamHPNomFlowRate
  ...
  annotation (Icon(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          {-100,90}}, color={0,0,255}),Line(points={{-20,30},{-20,200}},
          color={0,0,255}),Line(points={{100,30},{100,100},{120,100},
          {120,200}}, color={0,0,255}),Line(points={{160,-90},{160,-200}},
          color={0,0,255}),Line(points={{-160,30},{-160,120},{-160,
          146},{-160,204}}, color={0,0,255}),Polygon(
            ...
            {-160,30}},
                    ...
                    points={{-20,30},{-20,-30},{40,-90},{40,90},{-20,
            30}},   lineColor={0,0,0},
                    lineThickness=0.5,
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Polygon(
                    points={{100,30},{100,-30},{160,-90},{160,90},{
            100,30}},
                    lineColor={0,0,0},
                    lineThickness=0.5,
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{40,
          90},{40,200}}, color={0,0,255})}), Diagram(coordinateSystem(
        preserveAspectRatio=false,
        extent={{-200,-200},{200,200}},
