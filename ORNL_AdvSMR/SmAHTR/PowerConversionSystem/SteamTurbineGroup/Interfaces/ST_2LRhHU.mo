...
partial model ST_2LRhHU
  ...
  ThermoPower3.Water.FlangeB SteamForHU(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-60,
            -220},{-20,-180}}, rotation=0)));
  ...
  ThermoPower3.Water.FlangeA LPT_In_Rh(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-60,
  ...
  annotation (Icon(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          132},{140,132},{140,-140},{-40,-140},{-40,-198}}, color={0,
          ...
          points={{-100,200},{-100,88}}, color={0,0,255}),Line(points=
           {{-40,200},{-40,30}}, color={0,0,255}),Rectangle(
                    ...
                    fillColor={135,135,135}),Line(points={{80,-90},{
          80,-198}}, color={0,0,255}),Ellipse(
