...
partial model STGroup2LHU
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
                    ...
                    lineColor={0,0,255},
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{48,-134},
          {48,-70}}, color={0,0,255}),Ellipse(
                    extent={{28,-132},{68,-172}},
                    lineColor={0,0,255},
                    fillColor={255,255,255},
                    fillPattern=FillPattern.Solid),Line(points={{58,-142},
          {38,-142},{58,-152},{38,-162},{58,-162},{58,-162}}, color={
          0,0,255}),Ellipse(
                    extent={{136,-136},{144,-144}},
                    lineColor={0,0,255},
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{140,
          -140},{140,-198}}, color={0,0,255}),Line(points={{140,-140},
          {140,190}}, color={0,0,255}),Line(points={{48,-174},{48,-186},
          {110,-186},{110,-140},{140,-140}}, color={0,0,255}),Ellipse(
                    extent={{126,-92},{154,-120}},
                    lineColor={0,0,255},
                    fillColor={255,255,255},
                    fillPattern=FillPattern.Solid),Line(points={{140,
          -120},{140,-92},{152,-114},{140,-92},{128,-114}}, color={0,
          0,255}),Ellipse(
                    extent={{-20,136},{-12,128}},
                    lineColor={0,0,255},
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{-60,
          -196},{-60,-110},{100,-110},{100,132},{0,132}}, color={0,0,
          255}),Line(points={{-60,92},{-60,132},{0,132}}, color={0,0,
          255}),Line(points={{0,132},{0,200}}, color={0,0,255}),
          Rectangle(extent={{-200,16},{200,-12}},
                    lineColor={0,0,0},
                    lineThickness=0.5,
                    fillPattern=FillPattern.HorizontalCylinder,
                    fillColor={135,135,135}),Line(points={{-120,30},{
          -120,202}}, color={0,0,255}),Line(points={{-12,132},{-12,
          122},{-12,32}}, color={0,0,255}),Polygon(
                    points={{-50,138},{-50,126},{-34,132},{-50,138}},
                    lineColor={0,0,255},
                    fillPattern=FillPattern.Solid,
                    fillColor={0,0,255}),Polygon(
                    points={{-126,150},{-114,150},{-120,134},{-126,
            150}},  lineColor={0,0,255},
                    fillPattern=FillPattern.Solid,
                    fillColor={0,0,255}),Polygon(
                    ...
                    fillPattern=FillPattern.Solid,
                    fillColor={0,0,255}),Polygon(
                    points={{-120,32},{-120,-28},{-60,-88},{-60,92},{
            -120,32}},
                    lineColor={0,0,0},
                    lineThickness=0.5,
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Polygon(
                    points={{-12,32},{-12,-28},{48,-88},{48,92},{-12,
            32}},   lineColor={0,0,0},
                    lineThickness=0.5,
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Polygon(
