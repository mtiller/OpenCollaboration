...
partial model STGroup2LRh
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
                    ...
                    lineColor={0,0,255},
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{80,-128},
          {80,-80}}, color={0,0,255}),Ellipse(
                    extent={{60,-126},{100,-166}},
                    lineColor={0,0,255},
                    fillColor={255,255,255},
                    fillPattern=FillPattern.Solid),Line(points={{90,-136},
          {70,-136},{90,-146},{70,-156},{90,-156},{90,-156}}, color={
          0,0,255}),Line(points={{80,-170},{80,-180},{160,-180},{160,
          196}}, color={0,0,255}),Ellipse(
                    extent={{146,-132},{174,-160}},
                    lineColor={0,0,255},
                    fillColor={255,255,255},
                    fillPattern=FillPattern.Solid),Line(points={{160,
          -160},{160,-132},{172,-154},{160,-132},{148,-154}}, color={
          0,0,255}),Line(points={{-160,198},{-160,30}}, color={0,0,
          255}),Line(points={{-100,200},{-100,88}}, color={0,0,255}),
          Line(points={{-40,200},{-40,30}}, color={0,0,255}),
          Rectangle(extent={{-200,14},{200,-14}},
                    lineColor={0,0,0},
                    lineThickness=0.5,
                    fillPattern=FillPattern.HorizontalCylinder,
                    fillColor={135,135,135}),Line(points={{20,58},{20,
          140},{80,140},{80,198}}, color={0,0,255}),Polygon(
