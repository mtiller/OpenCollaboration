...
partial model STGroup3LRh
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
                    ...
                    fillPattern=FillPattern.Solid),Line(points={{110,
          -136},{90,-136},{110,-146},{90,-156},{110,-156},{110,-156}},
          color={0,0,255}),Line(points={{100,-168},{100,-186},{160,-186},
          {160,202}}, color={0,0,255}),Line(points={{140,-88},{140,-110},
          {100,-110},{100,-126}}, color={0,0,255}),Ellipse(
          ...
          {-100,90}}, color={0,0,255}),Line(points={{-40,30},{-40,200}},
          color={0,0,255}),Line(points={{80,30},{80,200}}, color={0,0,
          255}),Line(points={{20,90},{20,130},{80,130}}, color={0,0,
          255}),Ellipse(
                    ...
                    fillColor={0,0,255},
                    fillPattern=FillPattern.Solid),Line(points={{-160,
          30},{-160,120},{-160,146},{-160,204}}, color={0,0,255}),
          Polygon(  points={{-166,148},{-154,148},{-160,132},{-166,
