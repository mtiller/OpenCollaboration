...
partial model ST_2LRh_3t
  ...
  ThermoPower3.Water.FlangeB Tap2(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-50,
            -210},{-30,-190}}, rotation=0)));
  ThermoPower3.Water.FlangeB Tap3(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-10,
            -210},{10,-190}}, rotation=0)));
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          198},{-160,30}}, color={0,0,255}),Line(points={{-100,200},{
          -100,86}}, color={0,0,255}),Line(points={{-40,200},{-40,30}},
          color={0,0,255}),Rectangle(
                    extent={{-200,14},{202,-14}},
                    lineColor={0,0,0},
                    lineThickness=0.5,
                    fillPattern=FillPattern.HorizontalCylinder,
                    fillColor={135,135,135}),Line(points={{20,52},{20,
          140},{80,140},{80,198}}, color={0,0,255}),Line(points={{80,
          -76},{80,-198}}, color={0,0,255}),Line(
                    ...
                    points={{-40,30},{-40,-30},{80,-90},{80,92},{-40,
            30}},   lineColor={0,0,0},
                    lineThickness=0.5,
                    fillColor={0,0,255},
