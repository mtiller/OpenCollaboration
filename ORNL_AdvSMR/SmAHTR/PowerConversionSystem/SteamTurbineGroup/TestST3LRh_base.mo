...
model TestST3LRh_base
  ...
  SmAHTR.PowerConversionSystem.SteamTurbineGroup.ST3L_base
    steamTurbines(
  ...
  ORNL_AdvSMR.Components.SourceP sourceHPT(h=3.47e6, p0=1.28e7)
    annotation (Placement(transformation(
        origin={-72,66},
        extent={{-6,-6},{6,6}},
        rotation=270)));
  ORNL_AdvSMR.Components.SourceP sourceLPT(h=3.109e6, p0=6e5)
                                                           annotation (
  ...
  ORNL_AdvSMR.Components.SinkP sinkP(h=3.1076e6, p0=2980000)
                                                          annotation (
      Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=90,
        origin={-60,84})));
  ORNL_AdvSMR.Components.SourceP sourceP(h=3.554e6, p0=2680000)
    annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=270,
        origin={-48,66})));
