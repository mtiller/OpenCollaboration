...
model STG_3LRh_valve_cc
  ...
  SmAHTR.PowerConversionSystem.SteamTurbineGroup.ST3L_valve
    steamTurbines(
  ...
  SmAHTR.PowerConversionSystem.CondenserGroup.CondPlant_cc
    controlledCondeser(
    redeclare package FluidMedium = FluidMedium,
    Vtot=10,
    Vlstart=1.5,
...
equation
  ...
  connect(ActuatorsBus, steamTurbines.ActuatorsBus) annotation (Line(
        points={{200,-140},{100,-140},{100,-35},{20,-35}}, color={213,
          255,170}));
  ...
  connect(SensorsBus, controlledCondeser.SensorsBus) annotation (Line(
        points={{200,-80},{80,-80},{80,-122},{35.4,-122}}, color={255,
          170,213}));
