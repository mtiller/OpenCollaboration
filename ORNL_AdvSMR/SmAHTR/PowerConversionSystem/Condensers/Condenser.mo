...
model Condenser "Condenser"
  extends ORNL_AdvSMR.PowerConversionSystem.CondenserGroup.Interfaces.Condenser;
  ...
  parameter ThermoPower3.Choices.Flow1D.FFtypes FFtype_cool=
      ThermoPower3.Choices.Flow1D.FFtypes.NoFriction "Friction Factor Type";
  parameter ThermoPower3.Choices.Flow1D.HCtypes HCtype_cool=
      ThermoPower3.Choices.Flow1D.HCtypes.Downstream
  ...
  ORNL_AdvSMR.Components.Flow1D flowCooling(
    ...
    HydraulicCapacitance=HCtype_cool) annotation (Placement(
        ...
        extent={{-12,-10},{12,10}},
        rotation=90)));
  ThermoPower3.Thermal.ConvHT convHT(gamma=gamma_cool, N=N_cool)
