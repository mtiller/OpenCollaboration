...
model CoreFlowPaths2_works_pump
  ...
  ThermoPower3.Water.PumpNPSH primaryPump(
    ...
    n0=100) annotation (Placement(transformation(extent={{10,-77},{-10,
            -57}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    height=0,
    startTime=0,
    offset=250e6/(19*24)) annotation (Placement(transformation(extent={
            {-95,-37.5},{-80,-22.5}})));
  ...
  ThermoPower3.Water.PressDrop pressDrop(
    ...
    redeclare package Medium = ORNL_SMR.Media.Fluids.LiFBeF2.flibe_ph,
    dpnom(displayUnit="kPa") = 1) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-50,30})));
  ...
  Modelica.Blocks.Sources.Ramp ramp1(
    ...
    offset=-125e6/(19*24),
    height=0,
    startTime=0) annotation (Placement(transformation(extent={{95,22.5},
            {80,37.5}})));
equation
