...
model dRACS_AirToSalt4
  ...
  Modelica.Fluid.Pipes.DynamicPipe saltUp(
    ...
    p_a_start=100000,
    p_b_start=100000,
    T_start=953.15) annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        origin={-30,-90})));
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedHeatFlow1(T=
       1273.15)
...
equation
  ...
  connect(fixedHeatFlow1.port, plenum.heatPorts[2]) annotation (Line(
      points={{10,-180},{26.7,-180},{26.7,-158.8}},
      color={191,0,0},
      thickness=1,
      smooth=Smooth.None));
