...
model HeatExchangerFEM
  ...
  replaceable package shellMedium = ORNL_AdvSMR.Media.Fluids.KFZrF4.KFZrF4_ph
    constrainedby Modelica.Media.Interfaces.PartialMedium "Shell Medium";
  // Tube Medium
  replaceable package tubeMedium = ORNL_AdvSMR.Media.Fluids.KFZrF4.KFZrF4_ph
    constrainedby Modelica.Media.Interfaces.PartialMedium "Tube Medium";
  // number of Nodes
  ...
  ThermoPower3.Water.Flow1Dfem shell(
    ...
    dpnom=10000,
    DynamicMomentum=false) annotation (Placement(transformation(extent={{-20,-80},
            {20,-40}}, rotation=0)));
  ...
  ThermoPower3.Water.Flow1Dfem tube(
    ...
    FFtype=ThermoPower3.Choices.Flow1D.FFtypes.Colebrook,
    dpnom=10000,
    DynamicMomentum=true) annotation (Placement(transformation(extent={{20,80},
            {-20,40}}, rotation=0)));
  ...
  ThermoPower3.Water.SensT shellSens_in(redeclare package Medium = shellMedium)
    annotation (Placement(transformation(extent={{-70,-66},{-50,-46}}, rotation
          =0)));
  ThermoPower3.Water.SensT tubeSens_in(redeclare package Medium = tubeMedium)
    annotation (Placement(transformation(extent={{70,54},{50,74}}, rotation=0)));
  ThermoPower3.Water.SensT shellSens_out(redeclare package Medium = shellMedium)
    annotation (Placement(transformation(extent={{50,-66},{70,-46}}, rotation=0)));
  ThermoPower3.Water.SensT tubeSens_out(redeclare package Medium = tubeMedium)
