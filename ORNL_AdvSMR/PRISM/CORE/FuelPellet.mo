...
model FuelPellet "1-D model of thermal model for generalized fuel pins"
...
equation
  ...
  k_g = 0.1*(93.0 - 0.0581*T_g + 1.173e-5*T_g^2)
  ...
  cp_c = 1000*(0.475 .+ 2*0.00007 .* T_c .- 2876.1 ./ T_c .^ 2);
  ...
  T_c[radNodes_c] = wall.T;
  // wall.Q_flow + powerIn = 0;  // Energy balance
  // wall.Q_flow = k_c[radNodes_c]*(T_c[radNodes_c] - T_c[radNodes_c - 1])/delta_c * (0.0116*5.04);
