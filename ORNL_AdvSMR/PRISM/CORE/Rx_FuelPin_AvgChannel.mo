...
equation
  ...
  connect(convec.fluidside, channel.wall) annotation (Line(
      ...
      color={255,127,0},
      smooth=Smooth.None));
  connect(channelIn.flange, channel.infl) annotation (Line(
      points={{80,-30},{80,-10}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(channelOut.flange, channel.outfl) annotation (Line(
