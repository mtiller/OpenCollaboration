within ORNL_AdvSMR.PRISM.Media.MaterialProperties.Metals;
model HastelloyN "Material properties for Hastelloy N (R)"
  extends Common.MaterialTable(
    ...
    tableLinearExpansionCoefficient=Functions.CtoKTable([204, 11.6e-6; 316,
        ...
        15.3e-6; 982, 15.8e-6]),
    tableSpecificHeatCapacity=Functions.CtoKTable([100, 419; 200, 440; 300, 456;
        400, 469; 480, 477; 540, 485; 570, 523; 590, 565; 620, 586; 660, 582;
        680, 578; 700, 578]),
