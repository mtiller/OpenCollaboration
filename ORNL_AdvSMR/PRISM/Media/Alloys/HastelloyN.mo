...
model HastelloyN "Material properties for Hastelloy N (R)"
  extends MaterialProperties.Common.MaterialTable(
    ...
    tableLinearExpansionCoefficient=MaterialProperties.Functions.CtoKTable([204,
        11.6e-6; 316, 12.3e-6; 427, 12.7e-6; 538, 13.4e-6; 649, 14.0e-6; 760,
        14.7e-6; 871, 15.3e-6; 982, 15.8e-6]),
    tableSpecificHeatCapacity=MaterialProperties.Functions.CtoKTable([100, 419;
        200, 440; 300, 456; 400, 469; 480, 477; 540, 485; 570, 523; 590, 565;
        620, 586; 660, 582; 680, 578; 700, 578]),
    tableThermalConductivity=MaterialProperties.Functions.CtoKTable([100, 11.5;
        200, 13.1; 300, 14.4; 400, 16.5; 500, 18.0; 600, 20.3; 700, 23.6]));
