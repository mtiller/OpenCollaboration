within ORNL_AdvSMR.PRISM.Media.Fluids.Water.IF97_Utilities.BaseIF97.Transport;
...
algorithm
  ...
  assert((p <= 500e6 and (Tc >= 0.0 and Tc <= 150)) or (p <=
    350e6 and (Tc > 150.0 and Tc <= 600)) or (p <= 300e6 and (
    Tc > 600.0 and Tc <= 900)),
