...
protected
  constant Real[:] n={0.795544074093975e2,-0.238261242984590e4,
      ...
      0.297544599376982e3,-0.350315206871242e8,
      0.277513761062119,-0.523964271036888,-0.148011182995403e6,
      0.160014899374266e7,0.170802322663427e13,
      ...
      0.164094443541384e-1,-0.680468275301065e-1,
      0.257988576101640e-1,-0.145749861944416e-3};
  constant Real[:] I={-12,-12,-12,-10,-10,-10,-10,-8,-8,-8,-8,-6,
...
algorithm
  v := sum(n[i]*(pi + 0.187)^I[i]*(sigma - 0.755)^J[i] for i in
        1:28)*vstar;
