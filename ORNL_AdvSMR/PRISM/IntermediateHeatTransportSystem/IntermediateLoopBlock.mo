...
model IntermediateLoopBlock
  ...
  Components.Pump intermediatePump(
    ...
    redeclare function flowCharacteristic =
        ORNL_AdvSMR.Functions.PumpCharacteristics.linearFlow (q_nom={1.2618,
            2.5236}, head_nom={39.1275,30})) annotation (Placement(
  ...
  Modelica.Fluid.Fittings.Bends.CurvedBend upOutTurn(redeclare package Medium
      ...
      Placement(transformation(
        ...
        rotation=270,
        origin={70,59.5})));
  Thermal.DHThtc intermediateIn(N=nNodes)
    annotation (Placement(transformation(extent={{-105,-20},{-95,20}})));
  Thermal.DHThtc intermediateOut(N=nNodes) annotation (Placement(transformation(
          extent={{95,-20},{105,20}}), iconTransformation(extent={{95,-20},{105,
            20}})));
equation
  ...
  connect(ihxOutTurn.port_b, ihx2up.infl) annotation (Line(
      points={{-75,64.5},{-75,74.5},{-60,74.5}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
  ...
  connect(ihxOutTurn.port_a, riserTo.outlet) annotation (Line(
      points={{-75,44.5},{-75,35.5}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
  connect(intermediateIn, ihxTube.wall) annotation (Line(
      points={{-100,0},{-91.5,0},{-91.5,-0.075},{-82.5,-0.075}},
      color={255,127,0},
      smooth=Smooth.None));
  connect(sgTube.wall, intermediateOut) annotation (Line(
      points={{77.5,0.075},{87.75,0.075},{87.75,0},{100,0}},
      color={255,127,0},
      smooth=Smooth.None));
  annotation (
