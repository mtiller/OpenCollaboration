...
model IntermediateLoopBlock_w2FluidPorts
  ...
  Modelica.Fluid.Fittings.Bends.CurvedBend upOutTurn(redeclare package Medium
      ...
      Placement(transformation(
        ...
        rotation=270,
        origin={70,59.5})));
  Interfaces.FlangeA fromIHX(redeclare package Medium =
        ORNL_AdvSMR.Media.Fluids.Na) annotation (Placement(transformation(
          extent={{-110,10},{-90,30}}), iconTransformation(extent={{-110,60},{-90,
            80}})));
  Interfaces.FlangeB toIHX(redeclare package Medium =
        ORNL_AdvSMR.Media.Fluids.Na) annotation (Placement(transformation(
          extent={{-110,-30},{-90,-10}}), iconTransformation(extent={{-110,20},
            {-90,40}})));
  Interfaces.FlangeA fromSG(redeclare package Medium =
        ORNL_AdvSMR.Media.Fluids.Na) annotation (Placement(transformation(
          extent={{90,-30},{110,-10}}), iconTransformation(extent={{90,-80},{
            110,-60}})));
  Interfaces.FlangeB toSG(redeclare package Medium =
        ORNL_AdvSMR.Media.Fluids.Na) annotation (Placement(transformation(
          extent={{90,10},{110,30}}), iconTransformation(extent={{90,-40},{110,
            -20}})));
equation
  ...
  connect(ihxOutTurn.port_a, riserTo.outlet) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=0.5));
  connect(toIHX, riserTi.outlet) annotation (Line(
      points={{-100,-20},{-80,-20},{-80,-44}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(fromIHX, riserTo.inlet) annotation (Line(
      points={{-100,20},{-80,20},{-80,29}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(dcTi.outlet, toSG) annotation (Line(
      points={{70,27.5},{70,20},{100,20}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(dcTo.inlet, fromSG) annotation (Line(
      points={{70,-34},{70,-20},{100,-20}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  annotation (
...
end IntermediateLoopBlock_w2FluidPorts;
