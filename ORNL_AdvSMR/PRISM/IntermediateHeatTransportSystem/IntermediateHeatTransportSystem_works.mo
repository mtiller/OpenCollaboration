...
model IntermediateHeatTransportSystem_works
  ...
  Thermal.DHThtc intermediateOut(N=nNodes) annotation (Placement(transformation(
          extent={{95,-20},{105,20}}), iconTransformation(extent={{110,-100},{
            100,100}})));
...
equation
  ...
  connect(sgTube.wall, intermediateOut) annotation (Line(
      points={{77.5,0.075},{89,0.075},{89,0},{100,0}},
      color={255,127,0},
      smooth=Smooth.None));
...
end IntermediateHeatTransportSystem_works;
