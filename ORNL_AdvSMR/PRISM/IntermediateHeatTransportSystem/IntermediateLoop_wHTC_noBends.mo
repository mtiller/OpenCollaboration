...
model IntermediateLoop_wHTC_noBends
  ...
  Components.Pump intermediatePump(
    ...
    Np0=1) annotation (Placement(transformation(extent={{10,-80},{-10,-60}},
          rotation=0)));
  ...
  Components.SodiumExpansionTank sodiumExpansionTank(
    ...
    pext=100000,
    ystart=2.5)
    annotation (Placement(transformation(extent={{-15,55.5},{15,85.5}})));
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    duration=2500,
    offset=-2.96e6/2139,
    height=2*(-212.5e6 - 66.645e6)/2139,
    startTime=1e3)
...
end IntermediateLoop_wHTC_noBends;
