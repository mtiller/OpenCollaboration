...
equation
  ...
  connect(counterFlowConvection.tubeSide, ihxTube.wall) annotation (Line(
      points={{-85.5,0},{-82.5,0},{-82.5,-0.075},{-77.5,-0.075}},
      color={255,127,0},
      smooth=Smooth.None));
  ...
  connect(pump2ihx.infl, sg2pump.outfl) annotation (Line(
      points={{-10,-75},{10,-75}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
