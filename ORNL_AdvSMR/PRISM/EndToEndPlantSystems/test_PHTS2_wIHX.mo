...
model test_PHTS2_wIHX
  ...
  Implementations.PrimaryHeatTransportSystem.PRISM_PHTS1
    primaryHeatTransportSystem(noAxialNodes=10, FFtype=ORNL_AdvSMR.Choices.Flow1D.FFtypes.Colebrook)
  ...
  PowerSystems.HeatExchangers.IntermediateHeatExchanger
    ...
    flowPathLength=1,
    Twall_start=278.15)
    annotation (Placement(transformation(extent={{-35,-14},{5,26}})));
  ...
  Modelica.Blocks.Sources.Trapezoid rho_CR(
    ...
    rising=100,
    falling=100,
    amplitude=1e-4) annotation (Placement(transformation(
        extent={{-5,-5},{5,5}},
        rotation=0,
        origin={-90,15})));
