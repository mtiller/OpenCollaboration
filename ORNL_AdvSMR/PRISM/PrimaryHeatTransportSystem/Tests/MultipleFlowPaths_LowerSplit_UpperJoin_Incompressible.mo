...
model MultipleFlowPaths_LowerSplit_UpperJoin_Incompressible
  ...
  Components.PipeFlow_incompressible core(
    ...
    redeclare package Medium =
        ORNL_AdvSMR.Media.Fluids.LiFBeF2.flibe_incompressible,
    hstartin=2.5e6,
    hstartout=2.5e6,
  ...
  Components.Pump_Incompressible primaryPump(
    ...
    redeclare function flowCharacteristic =
        ThermoPower3.Functions.PumpCharacteristics.linearFlow (head_nom={0.05,
            0.75}, q_nom={1e-4,5e-4}),
  ...
  Modelica.Blocks.Sources.Ramp ramp3(
    ...
    offset=100,
    startTime=250,
    height=0) annotation (Placement(transformation(extent={{40,-50},{30,-40}})));
...
equation
  ...
  connect(downcomer.wall, heatSource1D1.wall) annotation (Line(
      points={{57.5,0.075},{66,0.075},{66,0},{68.5,0}},
      color={255,127,0},
      thickness=0.5,
      smooth=Smooth.None));
