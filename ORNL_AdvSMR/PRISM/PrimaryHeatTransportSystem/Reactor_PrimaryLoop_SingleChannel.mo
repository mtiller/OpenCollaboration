...
model Reactor_PrimaryLoop_SingleChannel
  ...
  CORE.ReactorKinetics reactorKinetics(
    ...
    noFuelPins=1,
    Q_nom=20e3)
    annotation (Placement(transformation(extent={{-66,-25},{-16,25}})));
...
equation
  ...
  connect(fuelPinModel.T_fe, reactorKinetics.T_fe) annotation (Line(
      points={{17.25,-75},{17.25,-95},{-26,-95},{-26,-25}},
      color={0,0,0},
...
end Reactor_PrimaryLoop_SingleChannel;
