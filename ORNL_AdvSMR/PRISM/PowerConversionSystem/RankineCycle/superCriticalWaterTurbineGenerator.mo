...
model superCriticalWaterTurbineGenerator
  ...
  CondenserGroup.CondPlant_cc controlledCondenser(
    ...
    SSInit=SSInit,
    p=5398.2) annotation (Placement(transformation(extent={{-6,-85},{34,-45}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.BooleanStep booleanStep(startTime=400, startValue=
        ...
        rotation=0,
        origin={87.5,5})));
  Interfaces.FlangeA steamIn annotation (Placement(transformation(extent={{-95,
            90},{-75,110}}), iconTransformation(extent={{-95,90},{-75,110}})));
  Interfaces.FlangeB waterOut annotation (Placement(transformation(extent={{-60,
            90},{-40,110}}), iconTransformation(extent={{-60,90},{-40,110}})));
...
equation
  ...
  connect(tenStageLowPressureTurbine.tap3, controlledCondenser.SteamIn)
    annotation (Line(
      points={{15.5,-21},{15.5,-33},{14,-33},{14,-45}},
      color={0,127,255},
      thickness=1,
      smooth=Smooth.None));
  ...
  connect(fourStageTurbine.turbineOutlet, tenStageLowPressureTurbine.turbineInlet)
    annotation (Line(
      points={{-57,-20},{-57,-30.5},{-45,-30.5},{-45,45},{-10,45},{-10,15.15}},
...
System"),Bitmap(extent={{-95,95},{95,-45}}, fileName=
          "modelica://ORNL_AdvSMR/Icons/Steam Turbine.jpg")}),
    experiment(
      StopTime=1000,
