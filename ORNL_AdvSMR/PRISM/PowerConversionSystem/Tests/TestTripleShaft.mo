...
protected
  ThermoPower3.PowerPlants.Buses.Sensors sensors annotation (Placement(
        ...
        extent={{-5,-5},{5,5}},
        rotation=180)));
  ThermoPower3.PowerPlants.Buses.Actuators actuators annotation (Placement(
        transformation(extent={{70,-70},{80,-60}}, rotation=0)));
public
  ...
  ThermoPower3.PowerPlants.ElectricGeneratorGroup.Examples.TripleShaft_static
    ...
    SSInit=true) annotation (Placement(transformation(extent={{0,-50},{80,30}},
          rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola Turbine1(
    ...
    eta_iso_nom=0.83,
    PRstart=5,
    pnom=12800000) annotation (Placement(transformation(extent={{-80,30},{-40,
            70}}, rotation=0)));
  ThermoPower3.Water.SourceW sourceW1(
    h=3.47e6,
    w0=67.6,
    p0=12800000) annotation (Placement(transformation(extent={{-90,40},{-80,50}},
          rotation=0)));
  ThermoPower3.Water.SinkP sinkP1(h=3.1076e6, p0=2980000) annotation (Placement(
        transformation(extent={{-40,80},{-30,90}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola Turbine2(
    ...
    wnom=81.1,
    PRstart=5,
    pnom=2700000) annotation (Placement(transformation(extent={{-80,-30},{-40,
            10}}, rotation=0)));
  ThermoPower3.Water.SourceW sourceW2(
    h=3.554e6,
    w0=81.1,
    p0=2700000) annotation (Placement(transformation(extent={{-90,20},{-80,30}},
          rotation=0)));
  ThermoPower3.Water.SinkP sinkP2(h=3.128e6, p0=600000) annotation (Placement(
        transformation(extent={{-40,20},{-30,30}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola Turbine3(
    wstart=89.82,
    wnom=89.82,
    Kt=0.0769,
    PRstart=5,
    pnom=600000) annotation (Placement(transformation(extent={{-80,-90},{-40,-50}},
          rotation=0)));
  ThermoPower3.Water.SourceW sourceW3(
    h=3.109e6,
    w0=89.82,
    p0=600000) annotation (Placement(transformation(extent={{-90,-40},{-80,-30}},
          rotation=0)));
  ThermoPower3.Water.SinkP sinkP3(h=2.3854, p0=5398.2) annotation (Placement(
        transformation(extent={{-40,-40},{-30,-30}}, rotation=0)));
...
equation
  connect(tripleShaft.SensorsBus, sensors) annotation (Line(points={{80,-26},{
          90,-26},{90,45},{75,45}}, color={255,170,213}));
  connect(actuators, tripleShaft.ActuatorsBus) annotation (Line(points={{75,-65},
          {90,-65},{90,-38},{80,-38}}, color={213,255,170}));
  connect(booleanConstant.y, actuators.breakerClosed_shaftA) annotation (Line(
        points={{41,-88},{60,-88},{60,-65},{75,-65}}, color={255,0,255}));
  connect(booleanConstant.y, actuators.breakerClosed_shaftB) annotation (Line(
        points={{41,-88},{55,-88},{55,-65},{75,-65}}, color={255,0,255}));
  connect(booleanConstant.y, actuators.breakerClosed_shaftC) annotation (Line(
        points={{41,-88},{50,-88},{50,-65},{75,-65}}, color={255,0,255}));
