...
public
  ...
  Modelica.Blocks.Math.Add add annotation (Placement(transformation(
        ...
        extent={{-7,-7},{7,7}},
        rotation=180)));
  ORNL_AdvSMR.PRISM.PowerConversionSystem.ElectricGenerators.OldElementsSwingEquation.Generator_SE_Breaker
    generator_SE(
    Pmax=30e6,
    omega_nom=157.08,
    eta=0.96,
    ...
    omega_start=157.08,
    r=0.2,
    delta_start=0.5073) annotation (Placement(transformation(extent={{-30,-48},
            {50,32}}, rotation=0)));
...
equation
  ...
  connect(grid.connection, generator_SE.powerConnection) annotation (Line(
      ...
      thickness=0.5));
  connect(booleanConstant.y, generator_SE.closed) annotation (Line(points={{59,
          56},{78,56},{78,30},{10,30},{10,19.2}}, color={255,0,255}));
