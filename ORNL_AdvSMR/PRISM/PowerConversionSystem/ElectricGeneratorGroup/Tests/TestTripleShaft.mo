...
public
  ...
  ORNL_AdvSMR.PRISM.PowerConversionSystem.ElectricGeneratorGroup.Examples.TripleShaft_static
    tripleShaft(
    Pn=50e8,
    J_shaft_A=2000,
    J_shaft_B=2000,
  ...
  ORNL_AdvSMR.PRISM.PowerConversionSystem.SteamTurbines.SteamTurbineStodola
    ...
    eta_iso_nom=0.83,
    PRstart=5,
    pnom=12800000) annotation (Placement(transformation(extent={{-84,40},{-44,
            80}}, rotation=0)));
  ORNL_AdvSMR.Components.SourceW sourceW1(
    h=3.47e6,
    w0=67.6,
    p0=128e5) annotation (Placement(transformation(extent={{-100,80},{-86,94}},
          rotation=0)));
  ...
  ORNL_AdvSMR.PRISM.PowerConversionSystem.SteamTurbines.SteamTurbineStodola
    ...
    wnom=81.1,
    PRstart=5,
    pnom=2700000) annotation (Placement(transformation(extent={{-84,-20},{-44,
            20}}, rotation=0)));
  ORNL_AdvSMR.Components.SourceW sourceW2(
    w0=81.1,
    p0=26.8e5,
    h=3.554e6) annotation (Placement(transformation(extent={{-100,24},{-86,38}},
          rotation=0)));
  ...
  ORNL_AdvSMR.PRISM.PowerConversionSystem.SteamTurbines.SteamTurbineStodola
    ...
    Kt=0.0769,
    PRstart=5,
    pnom=600000) annotation (Placement(transformation(extent={{-84,-78},{-44,-38}},
          rotation=0)));
  ORNL_AdvSMR.Components.SourceW sourceW3(
    w0=89.82,
    p0=6e5,
    h=3.109e6) annotation (Placement(transformation(extent={{-100,-36},{-86,-22}},
          rotation=0)));
  ORNL_AdvSMR.Components.SinkP sinkP3(p0=5.3982e3, h=2.3854) annotation (
