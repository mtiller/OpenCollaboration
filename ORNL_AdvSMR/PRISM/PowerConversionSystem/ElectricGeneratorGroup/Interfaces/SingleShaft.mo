...
partial model SingleShaft
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_a shaft annotation (Placement(
        transformation(extent={{-220,-20},{-180,20}}, rotation=0)));
  aSMR.Interfaces.ControlBus controlBus annotation (Placement(transformation(
          extent={{-40,-230},{40,-150}}), iconTransformation(extent={{-40,-230},
            {40,-150}})));
