within ORNL_AdvSMR.PRISM.PowerConversionSystem.ElectricGeneratorGroup.Examples.OldSwingEquation;
model TripleShaft_SE
  ...
  ElectricGenerators.PowerSensor powerSensor_A annotation (
      Placement(transformation(extent={{10,110},{30,130}}, rotation=
           0)));
  ElectricGenerators.FrequencySensor frequencySensor_A annotation (
      Placement(transformation(extent={{10,150},{30,170}}, rotation=
           0)));
  ElectricGenerators.PowerSensor powerSensor_B annotation (
      Placement(transformation(extent={{10,-10},{30,10}}, rotation=
            0)));
  ElectricGenerators.FrequencySensor frequencySensor_B annotation (
      Placement(transformation(extent={{10,30},{30,50}}, rotation=0)));
  ElectricGenerators.PowerSensor powerSensor_C annotation (
      Placement(transformation(extent={{10,-130},{30,-110}},
          rotation=0)));
  ElectricGenerators.FrequencySensor frequencySensor_C annotation (
      Placement(transformation(extent={{10,-90},{30,-70}}, rotation=
           0)));
  ElectricGenerators.Grid_3in grid_3in(Pn=Pn, fn=fn) annotation (
      Placement(transformation(extent={{140,-20},{180,20}},
          rotation=0)));
  ElectricGenerators.OldElementsSwingEquation.Generator_SE
    generator_SE_A(
    eta=eta_A,
    Pmax=Pmax_A,
    J=J_shaft_A,
