...
model DoubleShaft_SE
  ...
  ElectricGenerators.PowerSensor powerSensor_A annotation (
      Placement(transformation(extent={{20,90},{40,110}}, rotation=
            0)));
  ElectricGenerators.FrequencySensor frequencySensor_A annotation (
      Placement(transformation(extent={{20,130},{40,150}}, rotation=
           0)));
  ElectricGenerators.PowerSensor powerSensor_B annotation (
      Placement(transformation(extent={{20,-110},{40,-90}},
          rotation=0)));
  ElectricGenerators.FrequencySensor frequencySensor_B annotation (
      Placement(transformation(extent={{20,-70},{40,-50}}, rotation=
           0)));
  ElectricGenerators.Grid_2in grid(Pn=Pn, fn=fn) annotation (
      Placement(transformation(extent={{140,-20},{178,20}},
          rotation=0)));
