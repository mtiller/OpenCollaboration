...
model ST3L_bypass
  ...
  ThermoPower3.Water.ValveVap byPassLP(
    ...
    wnom=steamLPNomFlowRate + steamIPNomFlowRate + steamHPNomFlowRate,
    Cv=bypassLP_Cv,
    dpnom=steamLPNomPressure - pcond) annotation (Placement(transformation(
        origin={120,40},
        extent={{10,10},{-10,-10}},
        rotation=180)));
  ThermoPower3.Water.SensP p_ST_LP(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{90,74},{110,94}}, rotation=0)));
protected
  replaceable
...
public
  ThermoPower3.Water.SteamTurbineStodola ST_HP(
    ...
    pnom=steamHPNomPressure) annotation (Placement(transformation(extent={{-120,
            -20},{-80,20}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_IP(
    ...
    pnom=steamIPNomPressure) annotation (Placement(transformation(extent={{8,-20},
            {48,20}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_LP(
    ...
    pnom=steamLPNomPressure) annotation (Placement(transformation(extent={{120,
            -20},{160,20}}, rotation=0)));
equation
  connect(ActuatorsBus.Opening_valveHP, valveHP.theta) annotation (Line(points=
          {{200,-140},{-180,-140},{-180,30},{-140,30},{-140,24}}, color={213,
          255,170}));
  connect(ActuatorsBus.Opening_valveIP, valveIP.theta) annotation (Line(points=
          {{200,-140},{-60,-140},{-60,34},{-20,34},{-20,24}}, color={213,255,
          170}));
  connect(ActuatorsBus.Opening_valveLP, valveLP.theta) annotation (Line(points=
          {{200,-140},{60,-140},{60,32},{100,32},{100,24}}, color={213,255,170}));
  connect(ActuatorsBus.Opening_byPassHP, byPassHP.theta) annotation (Line(
        points={{200,-140},{-180,-140},{-180,30},{-140,30},{-140,60},{-120,60},
          {-120,48}}, color={213,255,170}));
  connect(ActuatorsBus.Opening_byPassIP, byPassIP.theta) annotation (Line(
        points={{200,-140},{-60,-140},{-60,34},{-20,34},{-20,60},{9.79717e-016,
          60},{9.79717e-016,48}}, color={213,255,170}));
  connect(ActuatorsBus.Opening_byPassLP, byPassLP.theta) annotation (Line(
        points={{200,-140},{60,-140},{60,32},{100,32},{100,60},{120,60},{120,48}},
        color={213,255,170}));
  connect(SensorsBus.p_STLP_in, p_ST_LP.p) annotation (Line(points={{200,-80},{
          -60,-80},{-60,160},{134,160},{134,90},{108,90}}, color={255,170,213}));
