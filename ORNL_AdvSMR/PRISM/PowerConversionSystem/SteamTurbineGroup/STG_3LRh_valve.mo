...
model STG_3LRh_valve
  ...
  ThermoPower3.PowerPlants.SteamTurbineGroup.Examples.ST3L_valve steamTurbines(
...
equation
  ...
  connect(SensorsBus, steamTurbines.SensorsBus) annotation (Line(points={{200,-80},
          {66,-80},{66,-20},{20,-20}}, color={255,170,213}));
  ...
  connect(ActuatorsBus.nPump_feedLP, totalFeedPump.pumpSpeed_rpm) annotation (
      Line(points={{200,-140},{60,-140},{60,-170.4},{86.48,-170.4}}, color={213,
          255,170}));
