...
model TestST3LRh_base_noMixing
  ...
  ORNL_AdvSMR.PRISM.PowerConversionSystem.SteamTurbineGroup.ST3L_base_noMixing
    steamTurbines(
    ...
    pcond=5398.2) annotation (Placement(transformation(extent={{-75,-50},{25,50}},
          rotation=0)));
  ...
  ORNL_AdvSMR.Components.SourceP sourceHPT(h=3.47e6, p0=12800000) annotation (
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    height=-8e5,
    offset=128e5)
    annotation (Placement(transformation(extent={{-100,85},{-85,100}})));
equation
