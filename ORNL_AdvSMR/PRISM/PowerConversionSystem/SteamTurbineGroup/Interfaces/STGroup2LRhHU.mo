...
partial model STGroup2LRhHU
  ...
  ORNL_AdvSMR.Interfaces.FlangeB SteamForHU(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-58,-220},{-18,
            -180}}, rotation=0)));
  ORNL_AdvSMR.Interfaces.FlangeA WaterFromHU(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{140,-220},{
            180,-180}}, rotation=0)));
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{80,-134},{80,-74}},
          color={0,0,255}),Ellipse(
          extent={{60,-132},{100,-172}},
          lineColor={0,0,255},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{90,-142},{70,-142},{90,-152},
          {70,-162},{90,-162},{90,-162}}, color={0,0,255}),Ellipse(
          extent={{156,-136},{164,-144}},
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{160,-140},{160,-198}},
          color={0,0,255}),Line(points={{160,-140},{160,194}}, color={0,0,255}),
          Line(points={{80,-176},{80,-186},{130,-186},{130,-140},{160,-140}},
          color={0,0,255}),Ellipse(
          extent={{146,-92},{174,-120}},
          lineColor={0,0,255},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{160,-120},{160,-92},{172,
          -114},{160,-92},{148,-114}}, color={0,0,255}),Ellipse(
          extent={{76,136},{84,128}},
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{-98,132},{134,132},{134,
          -110},{-40,-110},{-40,-198}}, color={0,0,255}),Line(points={{80,132},
