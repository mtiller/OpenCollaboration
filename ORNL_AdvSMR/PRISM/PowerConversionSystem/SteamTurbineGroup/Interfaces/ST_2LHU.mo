...
partial model ST_2LHU
  ...
  parameter Modelica.SIunits.Pressure LPT_pstart_out=pcond
    "Outlet pressure start value"
    annotation (Dialog(tab="Initialization", group="LP Turbine"));
  parameter Modelica.SIunits.MassFlowRate LPT_wstart=steamHPNomFlowRate
    "Mass flow rate start value"
    annotation (Dialog(tab="Initialization", group="LP Turbine"));
  ...
  ORNL_AdvSMR.Interfaces.FlangeB LPT_Out(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{28,-220},{68,-180}}, rotation
          =0)));
  ...
  annotation (Icon(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{-60,-198},{-60,-140},{
          140,-140},{140,130},{0,130}}, color={0,0,255}),Line(points={{-60,90},
          {-60,130},{0,130}}, color={0,0,255}),Line(points={{0,130},{0,198}},
          color={0,0,255}),Rectangle(
          extent={{-200,14},{200,-14}},
          lineColor={0,0,0},
          lineThickness=0.5,
          fillPattern=FillPattern.HorizontalCylinder,
          fillColor={135,135,135}),Line(points={{-120,28},{-120,200}}, color={0,
          0,255}),Line(points={{48,-90},{48,-192}}, color={0,0,255}),Line(
          points={{-12,130},{-12,120},{-12,30}}, color={0,0,255}),Polygon(
