...
partial model ST_3LRh_7t
  ...
  ThermoPower3.Water.FlangeB Tap3(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-100,-210},{-80,-190}},
          rotation=0)));
  ThermoPower3.Water.FlangeB Tap4(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-60,-210},{-40,-190}},
          rotation=0)));
  ThermoPower3.Water.FlangeB Tap5(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-20,-210},{0,-190}}, rotation
          =0)));
  ThermoPower3.Water.FlangeB Tap6(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{20,-210},{40,-190}}, rotation
          =0)));
  ThermoPower3.Water.FlangeB Tap7(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{60,-210},{80,-190}}, rotation
          =0)));
  ...
  ThermoPower3.Water.FlangeA IPT_In(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-60,180},{-20,220}}, rotation
          =0)));
  ThermoPower3.Water.FlangeB LPT_In(redeclare package Medium = FluidMedium)
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          fillColor={135,135,135}),Line(points={{-100,200},{-100,88}}, color={0,
          0,255}),Line(points={{-40,30},{-40,200}}, color={0,0,255}),Line(
          points={{80,30},{80,200}}, color={0,0,255}),Line(points={{20,84},{20,
          130},{80,130}}, color={0,0,255}),Ellipse(
          extent={{76,134},{84,126}},
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{140,-84},{140,-200}},
          color={0,0,255}),Line(points={{-160,30},{-160,120},{-160,146},{-160,
          204}}, color={0,0,255}),Line(
