...
partial model STGroup2L
  ...
  ORNL_AdvSMR.Interfaces.FlangeA From_SH_HP(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-140,180},{-100,
            220}}, rotation=0)));
  ORNL_AdvSMR.Interfaces.FlangeA From_SH_LP(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-20,180},{20,
            220}}, rotation=0)));
  ...
  annotation (Diagram(coordinateSystem(
        ...
        initialScale=0.1), graphics={Rectangle(
          ...
          lineColor={0,0,255},
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Line(points={{60,-126},{60,-78}},
          color={0,0,255}),Ellipse(
          extent={{40,-126},{80,-166}},
          lineColor={0,0,255},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{70,-136},{50,-136},{70,-146},
          {50,-156},{70,-156},{70,-156}}, color={0,0,255}),Line(points={{60,-170},
          {60,-180},{140,-180},{140,200}}, color={0,0,255}),Ellipse(
          extent={{126,-132},{154,-160}},
          lineColor={0,0,255},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{140,-160},{140,-132},{
          152,-154},{140,-132},{128,-154}}, color={0,0,255}),Rectangle(
          extent={{-200,14},{200,-14}},
          lineColor={0,0,0},
          lineThickness=0.5,
          fillPattern=FillPattern.HorizontalCylinder,
          fillColor={135,135,135}),Line(points={{-120,30},{-120,200}}, color={0,
          0,255}),Line(points={{0,30},{0,200}}, color={0,0,255}),Polygon(
