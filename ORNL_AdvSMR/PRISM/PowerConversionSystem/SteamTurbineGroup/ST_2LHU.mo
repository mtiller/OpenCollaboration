...
model ST_2LHU
  ...
  ThermoPower3.Water.SteamTurbineStodola ST_HP(
    ...
    pnom=steamHPNomPressure) annotation (Placement(transformation(extent={{-84,
            -20},{-44,20}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_LP(
    ...
    pnom=steamLPNomPressure) annotation (Placement(transformation(extent={{94,-20},
            {134,20}}, rotation=0)));
  ...
  ThermoPower3.Water.ValveVap valveLP(
    ...
    Cv=valveLP_Cv,
    wnom=steamHPNomFlowRate)
    annotation (Placement(transformation(extent={{60,6},{80,26}}, rotation=0)));
  ...
  ThermoPower3.Water.ValveVap byPassLP(
    ...
    wnom=steamHPNomFlowRate) annotation (Placement(transformation(extent={{80,
...
equation
  ...
  connect(ActuatorsBus.Opening_valveHP, valveHP.theta) annotation (Line(points=
          {{200,-140},{-140,-140},{-140,32},{-104,32},{-104,24}}, color={213,
          255,170}));
  connect(ActuatorsBus.Opening_valveLP, valveLP.theta) annotation (Line(points=
          {{200,-140},{50,-140},{50,32},{70,32},{70,24}}, color={213,255,170}));
  connect(ActuatorsBus.Opening_byPassHP, byPassHP.theta) annotation (Line(
        points={{200,-140},{20,-140},{20,70},{-90,70},{-90,58}}, color={213,255,
          170}));
  connect(ActuatorsBus.Opening_byPassLP, byPassLP.theta) annotation (Line(
        points={{200,-140},{50,-140},{50,70},{90,70},{90,58}}, color={213,255,
          170}));
  connect(ActuatorsBus.Opening_valveHU, valveHU.theta) annotation (Line(points=
          {{200,-140},{50,-140},{50,-60},{-40,-60},{-40,-25},{-26.2,-25}},
        color={213,255,170}));
