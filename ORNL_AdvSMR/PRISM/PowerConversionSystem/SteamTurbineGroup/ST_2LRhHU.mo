...
model ST_2LRhHU
  ...
  ThermoPower3.Water.SteamTurbineStodola ST_HP(
    ...
    pnom=steamHPNomPressure) annotation (Placement(transformation(extent={{-116,
            -20},{-76,20}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_LP(
    ...
    pnom=steamLPNomPressure) annotation (Placement(transformation(extent={{54,-20},
            {94,20}}, rotation=0)));
  ...
  ThermoPower3.Water.ValveVap valveLP(
    ...
    Cv=valveLP_Cv,
    wnom=steamHPNomFlowRate)
    annotation (Placement(transformation(extent={{20,6},{40,26}}, rotation=0)));
  ...
  ThermoPower3.Water.ValveVap byPassLP(
    ...
    wnom=steamHPNomFlowRate) annotation (Placement(transformation(extent={{40,
            40},{60,60}}, rotation=0)));
equation
