...
model STG_3LRh_bypass_cc
  ...
  ThermoPower3.PowerPlants.SteamTurbineGroup.Examples.ST3L_bypass steamTurbines(
...
equation
  ...
  connect(ActuatorsBus.nPump_feedLP, totalFeedPump.pumpSpeed_rpm) annotation (
      Line(points={{200,-140},{52,-140},{52,-170.4},{76.48,-170.4}}, color={213,
          255,170}));
