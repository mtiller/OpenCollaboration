...
model NetworkGridTwoGenerators "Base class for network with two port"
  extends Network2portBase(final C_ab=e_a*e_b/(X_a + X_b));
...
initial equation
  ...
  annotation (
    Diagram(graphics),
    Icon(graphics={Line(points={{32,0},{98,0}}, color={0,0,0}),Line(points={{-40,
          0},{-32,0},{-16,8}}, color={0,0,0}),Line(points={{-16,0},{16,0}},
          color={0,0,0}),Line(points={{0,2},{0,12},{8,24}}, color={0,0,0}),Line(
          points={{-30,64},{30,64}},
          color={0,0,0},
          thickness=0.5),Line(points={{0,64},{0,26}}, color={0,0,0}),Rectangle(
          extent={{-4,54},{4,36}},
          lineColor={0,0,0},
          ...
          lineColor={0,0,0},
          fillColor={0,0,0},
          fillPattern=FillPattern.Solid),Line(points={{-36,0},{-102,0}}, color=
          {0,0,0}),Rectangle(
          extent={{-66,4},{-48,-4}},
          lineColor={0,0,0},
          fillColor={255,255,255},
