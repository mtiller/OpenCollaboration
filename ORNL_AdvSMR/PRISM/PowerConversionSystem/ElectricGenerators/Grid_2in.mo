...
equation
  ...
  annotation (Diagram(graphics), Icon(graphics={Line(points={{18,-16},{2,-38}},
          color={0,0,0}),Line(points={{-72,-40},{-36,-20}}, color={0,0,0}),
          Ellipse(
          extent={{100,-68},{-40,68}},
          lineColor={0,0,0},
          lineThickness=0.5,
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{-40,0},{-6,0},{24,36},{
          ...
          lineColor={0,0,0},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),Line(points={{-72,40},{-36,20}}, color
          ={0,0,0})}));
end Grid_2in;
