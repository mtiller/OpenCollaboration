...
partial model CondPlantHU_base
  ...
  ORNL_AdvSMR.Interfaces.FlangeA CondensatedFromHU(redeclare package Medium =
        FluidMedium) annotation (Placement(transformation(extent={{-70,80},{-30,
            120}}, rotation=0)));
  ORNL_AdvSMR.Interfaces.FlangeA SteamIn(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{30,80},{70,120}}, rotation=0)));
  ...
  annotation (Diagram(graphics), Icon(graphics={Rectangle(
          ...
          color={0,0,255},
          thickness=0.5),Line(points={{0,-60},{0,-98}}, color={0,0,255}),Line(
          points={{-60,0},{-80,0},{-80,70},{-50,70},{-50,102}}, color={0,0,255}),
