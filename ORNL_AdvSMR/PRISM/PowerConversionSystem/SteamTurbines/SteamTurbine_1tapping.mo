...
model SteamTurbine_1tapping "Turbine with one tapping"
  ...
  ThermoPower3.Water.FlangeB tap1(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-6,-88},{12,-70}}, rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_firstStages(
    ...
    pnom=pnom_in) annotation (Placement(transformation(extent={{-44,-18},{-8,18}},
          rotation=0)));
  ThermoPower3.Water.SteamTurbineStodola ST_secondStages(
    ...
    pnom=pnom_tap) annotation (Placement(transformation(extent={{18,-18},{56,18}},
          rotation=0)));
  ThermoPower3.Water.FlangeA flangeA(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{-90,62},{-56,96}}, rotation=0)));
  ThermoPower3.Water.FlangeB flangeB(redeclare package Medium = FluidMedium)
    annotation (Placement(transformation(extent={{62,62},{96,96}}, rotation=0)));
...
equation
  ...
  connect(flangeB, ST_secondStages.outlet) annotation (Line(
      ...
      color={0,0,255},
      thickness=0.5));
  connect(partialArc, ST_firstStages.partialArc) annotation (Line(points={{-58,
          -38},{-36,-38},{-36,-26},{-52,-26},{-52,-7.2},{-35,-7.2}}, color={0,0,
          127}));
  ...
  annotation (Diagram(graphics), Icon(graphics={Polygon(
          points={{-26,76},{-26,28},{-20,28},{-20,82},{-58,82},{-58,76},{-26,76}},
          lineColor={0,0,0},
          lineThickness=0.5,
          fillColor={0,0,255},
          ...
          lineThickness=0.5,
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),Text(extent={{-126,136},{132,96}},
