...
partial model PartialPipeFlowHeatTransfer "Base class for pipe heat transfer correlation in terms of Nusselt number 
    heat transfer in a circular pipe for laminar and turbulent one-phase flow"
...
equation
  ...
  Res = Modelica.Fluid.Pipes.BaseClasses.CharacteristicNumbers.ReynoldsNumber(
    vs,
    ds,
    mus,
    diameters);
  Nus = Modelica.Fluid.Pipes.BaseClasses.CharacteristicNumbers.NusseltNumber(
    alphas,
    diameters,
    lambdas);
