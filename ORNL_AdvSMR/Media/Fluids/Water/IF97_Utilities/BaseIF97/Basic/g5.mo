...
algorithm
  assert(p > triple.ptriple,
    ...
    p) + " Pa <= " + String(triple.ptriple) + " Pa (triple point pressure)");
  ...
  g.g := g.pi*(-0.000125631835895920 + o[4] + g.pi*(-3.9724828359569e-6*o[8] +
    ...
    6.8540841634434 - 0.32961626538917*g.tau)*g.tau + Modelica.Math.log(g.pi)))))
    /o[5];
  ...
  g.gtau := g.pi*(0.00217746787145710 + o[11] + g.pi*(-0.000035752345523612*o[7]
     + 3.8757684869352e-7*o[1]*g.pi)) + (0.074415446800398 + g.tau*(-0.73803069960666
     + (3.11613182139250 + o[1]*(6.8540841634434 - 0.65923253077834*g.tau))*g.tau))
    /o[6];
  ...
  g.gtautau := (-0.297661787201592 + g.tau*(2.21409209881998 + (-6.2322636427850
    ...
    g.tau + g.pi*(-0.000286018764188897*o[1]*o[6]*g.tau + 7.7515369738704e-7*g.pi
    *g.tau));
