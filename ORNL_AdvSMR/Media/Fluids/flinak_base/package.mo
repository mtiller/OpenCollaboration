...
redeclare function density_pT
  ...
  output Density d "Density";
  algorithm
  d := 2579.3 - 0.6240*T "T in [800-1080 K]";
  end density_pT;
...
redeclare function extends surfaceTension
  ...
  sigma := 0.2928 - 1.2e-4*sat.Tsat
    "FLIBE - Cantor (1968) correlation for surface tension; only a function of temperature (K)";
  end surfaceTension;
...
redeclare function extends saturationTemperature
  "saturation temperature of flinak"
  algorithm
  T := 1843.15;
...
redeclare function extends saturationPressure "saturation pressure of flinak"
  algorithm
  p := 101325;
