...
protected
  final constant Medium.Temperature Tmin=273.15;
  //Medium.fluidLimits.TMIN;
  final constant Medium.Temperature Tcrit=647.096;
  //Medium.fluidConstants[1].criticalTemperature;
  final constant Medium.Temperature Tmax=1000;
  //Medium.fluidLimits.TMAX;
  final constant Medium.AbsolutePressure pmin=612;
  //Medium.fluidLimits.PMIN;
  final constant Medium.AbsolutePressure pcrit=22064000;
  //Medium.fluidConstants[1].criticalPressure;
  final constant Medium.AbsolutePressure pmax=100e6;
  //Medium.fluidLimits.PMAX;
