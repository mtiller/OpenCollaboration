...
extends Interfaces.PartialHelmholtzMedium(
  ...
  Density(
    min=fluidLimitsHelium.DMIN,
    max=fluidLimitsHelium.DMAX,
    start=fluidConstantsHelium.molarMass/fluidConstantsHelium.criticalMolarVolume),

  Temperature(
    min=fluidLimitsHelium.TMIN,
    max=fluidLimitsHelium.TMAX,
    start=298.15),
  AbsolutePressure(
    min=0,
    max=1000e6,
    start=101325),
  SpecificEnthalpy(
    min=fluidLimitsHelium.HMIN,
    max=fluidLimitsHelium.HMAX,
    start=(fluidLimitsHelium.HMIN + fluidLimitsHelium.HMAX)/2),
  SpecificEntropy(
    min=fluidLimitsHelium.SMIN,
    max=fluidLimitsHelium.SMAX,
    start=(fluidLimitsHelium.SMIN + fluidLimitsHelium.SMAX)/2));
...
final constant Interfaces.PartialHelmholtzMedium.FluidLimits fluidLimitsHelium(
...
final constant Interfaces.PartialHelmholtzMedium.EoS.HelmholtzCoefficients
  ...
  useLineSearch=true,
  idealLog=[1.5, 1],
  idealPower=[0.187171646656055, 0; 0.484851136045604, 1],
  idealEinstein=fill(
      0.0,
      0,
      2),
  ...
  idealSinh=fill(
      ...
      0,
      2),
  residualPoly=[0.9288766E-02, 1.0, 4, 0; 0.9258069E+00, 0.28, 1, 0; -0.1718156E+01,
      0.735, 1, 0; 0.7606137E+00, 0.64, 2, 0; -0.1024864E+01, 0.82, 2, 0;
      0.1052455E+00, 1.16, 3, 0],
  residualBwr=[-0.1875722E+00, 1.28, 1, 1; -0.1287812E+00, 2.0, 1, 2; -0.2227619E-02,
      0.41, 3, 2; 0.1823465E+00, 1.33, 2, 1; -0.4450014E-01, 4.2, 2, 2; -0.8729033E-04,
      0.6, 8, 1],
  residualGauss=[0.3854320E-01, 3.0, 1, 2, 2, -1.0833, -0.0385, 1.9776, 0.6914;
      -0.9585106E+00, 1.0, 1, 2, 2, -18.3824, -19.8246, 1.6178, 0.8590; -0.5454010E-01,
      8.2, 1, 2, 2, -5.0573, -9.3799, 0.4371, 0.8787; -0.3687260E-01, 1.0, 2, 2,
      2, -0.2832, -0.8073, 0.5355, 2.7182; -0.1021851E-02, 2.71, 2, 2, 2, -6.0582,
      -0.0310, 0.7777, 2.0301; 0.6166348E-01, 1.0, 2, 2, 2, -0.2444, -0.0061,
      0.4832, 0.8900; 0.2493437E-01, 1.0, 3, 2, 2, -0.0539, -0.3581, 0.8162,
      1.1790; -0.8127424E-02, 2.0, 3, 2, 2, -0.1850, -0.7518, 1.2896, 0.5680; -0.8233032E-02,
      1.0, 2, 2, 2, -0.5941, -7.4629, 0.3577, 1.6412])
...
final constant
  ...
  surfaceTensionCoefficientsHelium(coeffs=[0.05418, 1.26])
...
final constant
  ...
  pressureSaturation=[-0.399865E+01, 1.0; 0.870145E+00, 1.5; 0.171451E+00, 1.85;
      0.120927E+01, 2.7],
  densityLiquidModel=Interfaces.PartialHelmholtzMedium.Types.DensityLiquidModel.DL2,

  densityLiquid=[0.140808E+01, 1.17; -0.543843E+00, 7.0; 0.177220E+01, 15.0; -0.344056E+01,
      20.0],
  densityVaporModel=Interfaces.PartialHelmholtzMedium.Types.DensityVaporModel.DV3,

  densityVapor=[-0.126074E+01, 0.263; -0.363425E+01, 1.04; -0.487998E+01, 3.25;
      -0.130581E+02, 8.5],
  pressureMeltingModel=Interfaces.PartialHelmholtzMedium.Types.PressureMeltingModel.ML1,

  T_reducing=1,
  p_reducing=1000e3,
  pressureMelting1=[-1.7455837, 0.000000; 1.6979793, 1.555414],
