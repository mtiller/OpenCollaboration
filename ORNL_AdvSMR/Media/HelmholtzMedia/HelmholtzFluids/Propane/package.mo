...
extends Interfaces.PartialHelmholtzMedium(
  ...
  Density(
    min=fluidLimitsPropane.DMIN,
    max=fluidLimitsPropane.DMAX,
    start=fluidConstantsPropane.molarMass/fluidConstantsPropane.criticalMolarVolume),

  Temperature(
    min=fluidLimitsPropane.TMIN,
    max=fluidLimitsPropane.TMAX,
    start=298.15),
  AbsolutePressure(
    min=0,
    max=1000e6,
    start=101325),
  SpecificEnthalpy(
    min=fluidLimitsPropane.HMIN,
    max=fluidLimitsPropane.HMAX,
    start=(fluidLimitsPropane.HMIN + fluidLimitsPropane.HMAX)/2),
  SpecificEntropy(
    min=fluidLimitsPropane.SMIN,
    max=fluidLimitsPropane.SMAX,
    start=(fluidLimitsPropane.SMIN + fluidLimitsPropane.SMAX)/2));
...
final constant Interfaces.PartialHelmholtzMedium.FluidLimits fluidLimitsPropane(
...
final constant Interfaces.PartialHelmholtzMedium.EoS.HelmholtzCoefficients
  ...
  idealLog=[+3.0, 1.],
  idealPower=[-4.970583, 0.; +4.293520, 1.],
  idealEinstein=[+3.043, -1.062478; +5.874, -3.344237; +9.337, -5.363757; +
      7.922, -11.762957],
  residualPoly=[+0.42910051E-01, 1.00, 4., 0.; 0.17313671E+01, 0.33, 1., 0.; -0.24516524E+01,
      0.80, 1., 0.; 0.34157466E+00, 0.43, 2., 0.; -0.46047898E+00, 0.90, 2., 0.],

  residualBwr=[-0.66847295E+00, 2.46, 1., 1.; 0.20889705E+00, 2.09, 3., 1.;
      0.19421381E+00, 0.88, 6., 1.; -0.22917851E+00, 1.09, 6., 1.; -0.60405866E+00,
      3.25, 2., 2.; 0.66680654E-01, 4.62, 3., 2.],
  residualGauss=[0.17534618E-01, 0.76, 1., 2., 2., -0.963, -2.33, 0.684, 1.283;
      0.33874242E+00, 2.50, 1., 2., 2., -1.977, -3.47, 0.829, 0.6936;
      0.22228777E+00, 2.75, 1., 2., 2., -1.917, -3.15, 1.419, 0.788; -0.23219062E+00,
      3.05, 2., 2., 2., -2.307, -3.19, 0.817, 0.473; -0.92206940E-01, 2.55, 2.,
      2., 2., -2.546, -0.92, 1.500, 0.8577; -0.47575718E+00, 8.40, 4., 2., 2.,
      -3.28, -18.8, 1.426, 0.271; -0.17486824E-01, 6.75, 1., 2., 2., -14.6, -547.8,
      1.093, 0.948]) "Coefficients of the Helmholtz EoS";
...
final constant
  ...
  lambda_0_num_coeffs=[-1.24778E-3, 0; 8.16371E-3, 1; 1.99374E-2, 2],
  reducingTemperature_residual=369.85,
  reducingMolarVolume_residual=1/5000,
  reducingThermalConductivity_residual=1,
  lambda_r_coeffs=[-3.69500E-2, 0, 1, 0; 4.82798E-2, 1, 1, 0; 1.48658E-1, 0, 2,
      0; -1.35636E-1, 1, 2, 0; -1.19986E-1, 0, 3, 0; 1.17588E-1, 1, 3, 0;
      4.12431E-2, 0, 4, 0; -4.36911E-2, 1, 4, 0; -4.86905E-3, 0, 5, 0;
      6.16079E-3, 1, 5, 0],
  xi_0=0.194E-9,
  Gamma_0=0.0496,
...
final constant
  ...
  CET=[0.141824, 0.50],
  a=[0.25104574, 0; -0.47271238, 1; 0.060836515, 3],
  ...
  g=[0.250053938863E1, 0.0; 0.215175430074E1, 0.5],
  e=[0.359873030195E2, 0.0, 2.00, 0.00, 0; -0.180512188564E3, -1.0, 2.00, 0.00,
      0; 0.877124888223E2, -2.0, 2.00, 0.00, 0; -0.105773052525E3, 0.0, 3.00,
      0.00, 0; 0.205319740877E3, -1.0, 3.00, 0.00, 0; -0.129210932610E3, -2.0,
      3.00, 0.00, 0; 0.589491587759E2, 0.0, 4.00, 0.00, 0; -0.129740033100E3, -1.0,
      4.00, 0.00, 0; 0.766280419971E2, -2.0, 4.00, 0.00, 0; -0.959407868475E1,
      0.0, 5.00, 0.00, 0; 0.210726986598E2, -1.0, 5.00, 0.00, 0; -0.143971968187E2,
      -2.0, 5.00, 0.00, 0; -0.161688405374E4, 0.0, 1.00, -1.00, 0],
  nu_po=[0.161688405374E4, 0.0, 1, 0, 0],
  de_po=[1., 0.0, 0, 1, 0; -1., 0.0, 1, 0, 0])
  "Coefficients for the dynamic viscosity";

final constant
  Interfaces.PartialHelmholtzMedium.Transport.SurfaceTensionCoefficients
  surfaceTensionCoefficientsPropane(coeffs=[0.05666, 1.265; -0.005291, 2.265])
...
final constant
  ...
  pressureSaturation=[-6.7722, 1.0; 1.6938, 1.5; -1.3341, 2.2; -3.1876, 4.8;
      0.94937, 6.2],
  densityLiquidModel=Interfaces.PartialHelmholtzMedium.Types.DensityLiquidModel.DL1,

  densityLiquid=[1.82205, 0.345; 0.65802, 0.74; 0.21109, 2.6; 0.083973, 7.2],
  densityVaporModel=Interfaces.PartialHelmholtzMedium.Types.DensityVaporModel.DV3,

  densityVapor=[-2.4887, 0.3785; -5.1069, 1.07; -12.174, 2.7; -30.495, 5.5; -52.192,
      10.0; -134.89, 20.0],
  pressureMeltingModel=Interfaces.PartialHelmholtzMedium.Types.PressureMeltingModel.ML1,

  T_reducing=85.525,
  p_reducing=0.00017,
  pressureMelting1=[-4230000000000.0, 0; 4230000000001.0, 1.283],
  ...
  pressureMelting3=fill(
      0.0,
      0,
      2)) "Coefficients for the ancillary equations (PS5, DL1, DV3, ML1)";
