...
record ThermalConductivityCoefficients
  ...
  constant Real[:, 2] lambda_0_num_coeffs=fill(
      0.0,
      0,
      2) "coeffs for dilute contribution numerator";
  constant Real[:, 2] lambda_0_den_coeffs=fill(
      0.0,
      0,
      2) "coeffs for dilute contribution denominator";
  ...
  constant Real[:, 4] lambda_r_coeffs=fill(
      0.0,
      0,
      4) "coeffs for residual contribution";
