...
model Pump_Incompressible "Centrifugal pump with ideally controlled speed"
  extends PumpBase_Incompressible;
...
equation
  ...
  annotation (
    Icon(graphics={Text(extent={{-58,94},{-30,74}}, textString="n"),Text(extent
            ={{-10,102},{18,82}}, textString="Np")}),
    Diagram(graphics),
