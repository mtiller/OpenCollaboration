...
model LowerPlenum_2o "Splits a flow in two"
...
equation
  ...
  //   out1.h_outflow = (inStream(in1.h_outflow)*(in1.m_flow + wzero) + inStream(out2.h_outflow)*(
  //      out2.m_flow + wzero))/(in1.m_flow + 2*wzero + out2.m_flow);
  //
  //   out2.h_outflow = (inStream(in1.h_outflow)*(in1.m_flow + wzero) + inStream(out1.h_outflow)*(
  //      out1.m_flow + wzero))/(in1.m_flow + 2*wzero + out1.m_flow);
  //
