...
partial model PipeFlowBase
  ...
  replaceable package Medium = ORNL_AdvSMR.Media.Fluids.LiFBeF2.flibe_ph
    ...
    "Medium model" annotation (Evaluate=true, choicesAllMatching=true);
  ...
  parameter Real PoD=1.19 "Pitch-to-diameter ratio";
  ...
  replaceable ORNL_AdvSMR.Thermal.DHT wall(N=nNodes) annotation (Dialog(enable=
          false), Placement(transformation(extent={{-40,40},{40,60}}, rotation=
            0), iconTransformation(extent={{-40,40},{40,60}})));
