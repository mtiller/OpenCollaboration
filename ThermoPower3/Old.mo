...
package Old "Old models"
  model ValveLiq "Valve for liquid water flow"
    ...
    ThermoPower3.Water.FlangeAOld inlet annotation (Placement(transformation(
            extent={{-120,-20},{-80,20}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld outlet annotation (Placement(transformation(
...
<li><i>1 Oct 2003</i>
  ...
  model PumpOld "Centrifugal pump with controlled speed"
    extends ThermoPower3.Icons.Water.Pump;
    ...
    Real E;
    Real F;
    ThermoPower3.Water.FlangeAOld infl(p(start=pin_start)) annotation (
        Placement(transformation(extent={{-100,2},{-60,42}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld outfl(p(start=pout_start)) annotation (
  ...
  equation
    ...
    h = hout;
    p = infl.p;
    rho = ThermoPower3.Water.dens_ph(p, h);
...
<li><i>1 Oct 2003</i>
  ...
  model Pressuriser
    ...
    Real dVvdy;
    Real dVldy;
    ThermoPower3.Water.FlangeAOld feedwater annotation (Placement(
          transformation(extent={{-60,-34},{-26,0}}, rotation=0)));
    ThermoPower3.Water.FlangeAOld riser annotation (Placement(transformation(
            extent={{26,-36},{62,-2}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld downcomer annotation (Placement(
          transformation(extent={{-62,-80},{-26,-44}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld blowdown annotation (Placement(transformation(
            extent={{26,-80},{62,-44}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld steam annotation (Placement(transformation(
  ...
  equation
    ...
    // approx. value
    (Ts,hls,hvs) = ThermoPower3.Water.propsat_p_th(p);
    (Tv,rhov,drvdp,drvdh) = ThermoPower3.Water.prop_ph(p, hv);
    (Tl,rhol,drldp,drldh) = ThermoPower3.Water.prop_ph(p, hl);
    feedwater.p = p;
    feedwater.w = wf;
    feedwater.hAB = hl;
...
<li><i>1 Oct 2003</i>
  ...
  model Drum2States
    ...
    ThermoPower3.Water.FlangeAOld feed annotation (Placement(transformation(
...
<li><i>1 May 2004</i>
  ...
  model PressDrop "Pressure drop for water/steam flows"
    ...
    ThermoPower3.Water.FlangeAOld inlet(w(start=wnom)) annotation (Placement(
          transformation(extent={{-120,-20},{-80,20}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld outlet(w(start=-wnom)) annotation (Placement(
...
"));
  ...
  model Drum_explicit "Drum for circulation boilers"
    ...
    ThermoPower3.Water.FlangeAOld feedwater(redeclare package Medium = Medium)
      annotation (Placement(transformation(extent={{-114,-32},{-80,2}},
            rotation=0)));
    ThermoPower3.Water.FlangeAOld riser(redeclare package Medium = Medium)
      annotation (Placement(transformation(extent={{60,-74},{96,-40}}, rotation=
             0)));
    ThermoPower3.Water.FlangeBOld downcomer(redeclare package Medium = Medium)
      annotation (Placement(transformation(extent={{-88,-88},{-52,-52}},
            rotation=0)));
    ThermoPower3.Water.FlangeBOld blowdown(redeclare package Medium = Medium)
      annotation (Placement(transformation(extent={{-18,-116},{18,-80}},
            rotation=0)));
    ThermoPower3.Water.FlangeBOld steam(redeclare package Medium = Medium)
...
"));
  ...
  model Header_explicit "Header with metal walls for water/steam flows"
    ...
    ThermoPower3.Water.FlangeAOld inlet(
      p(start=pstartin),
      hAB(start=hstart),
      redeclare package Medium = Medium) annotation (Placement(transformation(
            extent={{-122,-20},{-80,20}}, rotation=0)));
    ThermoPower3.Water.FlangeBOld outlet(
      p(start=pstartout),
      hBA(start=hstart),
      redeclare package Medium = Medium) annotation (Placement(transformation(
            extent={{80,-20},{120,20}}, rotation=0)));
    ...
    model HRB "Heat recovery boiler model"
      ...
      Flow1DGasHT GasSide(
        ...
        N=Nr + 1) annotation (Placement(transformation(extent={{8,64},{-14,44}},
              rotation=0)));
      ThermoPower3.Gas.FlangeAOld gasInlet(redeclare package Medium = GasMedium)
        annotation (Placement(transformation(extent={{80,40},{100,60}},
              rotation=0)));
      ThermoPower3.Gas.FlangeBOld gasOutlet(redeclare package Medium =
            GasMedium) annotation (Placement(transformation(extent={{-100,40},{
                -80,60}}, rotation=0)));
      ThermoPower3.Water.FlangeAOld waterInlet(redeclare package Medium =
            WaterMedium) annotation (Placement(transformation(extent={{-100,-60},
                {-80,-40}}, rotation=0)));
      ThermoPower3.Water.FlangeBOld waterOutlet(redeclare package Medium =
