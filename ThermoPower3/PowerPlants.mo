...
package PowerPlants "Models of thermoelectrical power plants components"
  ...
  import ThermoPower3.Choices.Init.Options;
  ...
  package GasTurbine
    ...
    package Interfaces "Interface definitions"
      ...
      partial model GasTurbine "Base class for Gas Turbine"
        replaceable package FlueGasMedium = ThermoPower3.Media.FlueGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        replaceable package AirMedium = ThermoPower3.Media.Air constrainedby
          Modelica.Media.Interfaces.PartialMedium;
        replaceable package FuelMedium = ThermoPower3.Media.NaturalGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
    ...
    package Examples "Example implementations"
      ...
      model GasTurbineSimplified
        extends
          ThermoPower3.PowerPlants.GasTurbine.Interfaces.GasTurbineSimplified;
    ...
    package Tests "Test cases"
      model TestGasTurbine
        ...
        ThermoPower3.PowerPlants.HRSG.Components.StateReader_gas
          stateReader_gas(redeclare package Medium = ThermoPower3.Media.FlueGas)
  ...
  package HRSG "Models and tests of the HRSG and its main components"
    ...
    package Components "HRSG component models"
      ...
      model HE "Heat Exchanger fluid - gas"
        ...
        parameter Choices.Flow1D.FFtypes FFtype_G=ThermoPower3.Choices.Flow1D.FFtypes.NoFriction
        ...
        parameter Choices.Flow1D.FFtypes FFtype_F=ThermoPower3.Choices.Flow1D.FFtypes.NoFriction
        ...
        parameter Choices.Flow1D.HCtypes HCtype_F=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
      ...
      model ParHE "Parallel heat exchangers fluid - gas"
        ...
        parameter SI.Density rhonom_G=0 "Nominal inlet density, gas side";
        parameter Real Cfnom_G=0 "Nominal Fanning friction factor, gas side";
        parameter Choices.Flow1D.FFtypes FFtype_F_A=ThermoPower3.Choices.Flow1D.FFtypes.NoFriction
        ...
        parameter Real Cfnom_F_A=0 "Nominal Fanning friction factor"
          annotation (Dialog(group="side A"));
        parameter Choices.Flow1D.FFtypes FFtype_F_B=ThermoPower3.Choices.Flow1D.FFtypes.NoFriction
        ...
        parameter Real Cfnom_F_B=0 "Nominal Fanning friction factor"
          annotation (Dialog(group="side B"));
        parameter Choices.Flow1D.HCtypes HCtype_F_A=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(group="side A"));
        parameter Choices.Flow1D.HCtypes HCtype_F_B=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(group="side B"));
      ...
      model ParHE_Des
        ...
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.ParallelHE_Des;
        ...
        parameter SI.CoefficientOfHeatTransfer gamma_F_B_p1
          "Constant heat transfer coefficient in the fluid side"
          annotation (Dialog(tab="pHE-1", group="side B"));
        parameter Choices.Flow1D.HCtypes HCtype_F_A_p1=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(tab="pHE-1", group="side A"));
        parameter Choices.Flow1D.HCtypes HCtype_F_B_p1=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(tab="pHE-1", group="side B"));
        ...
        parameter SI.CoefficientOfHeatTransfer gamma_F_B_p2
          "Constant heat transfer coefficient in the fluid side"
          annotation (Dialog(tab="pHE-2", group="side B"));
        parameter Choices.Flow1D.HCtypes HCtype_F_A_p2=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(tab="pHE-2", group="side A"));
        parameter Choices.Flow1D.HCtypes HCtype_F_B_p2=ThermoPower3.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(tab="pHE-2", group="side B"));
      ...
      model Flow1Dhtc
        ...
        extends ThermoPower3.Water.Flow1D(redeclare ThermoPower3.Thermal.DHThtc
            wall);
      ...
      model Flow1D2phhtc
        ...
        extends ThermoPower3.Water.Flow1D2ph(redeclare
            ThermoPower3.Thermal.DHThtc wall);
        parameter SI.CoefficientOfHeatTransfer gamma_nom
          "Nominal h.t.c. coefficient";
        parameter Real kw
          "Exponent of the mass flow rate in the h.t.c. correlation";
      ...
      model FlowGas1Dhtc
        ...
        extends Gas.Flow1D(redeclare ThermoPower3.Thermal.DHThtc wall);
        parameter SI.CoefficientOfHeatTransfer gamma_nom
          "Nominal h.t.c. coefficient";
        parameter Real kw
          "Exponent of the mass flow rate in the h.t.c. correlation";
      ...
      model ConvParallel
        ...
        ThermoPower3.Thermal.DHT source(N=N) annotation (Placement(
              transformation(extent={{-40,60},{40,80}}, rotation=0)));
        ThermoPower3.Thermal.DHT objectA(N=N) annotation (Placement(
              transformation(extent={{-100,-40},{-20,-20}}, rotation=0)));
        ThermoPower3.Thermal.DHT objectB(N=N) annotation (Placement(
...
<li><i>1 Oct 2003</i>
    by <a href=\"mailto:francesco.casella@polimi.it\">Francesco Casella</a>:<br>
      ...
      model StateReader_water
        ...
        extends ThermoPower3.PowerPlants.HRSG.Components.BaseReader_water;
      ...
      public
        ...
        ThermoPower3.Water.SensW feed_w(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(
              ...
              extent={{10,10},{-10,-10}},
              rotation=180)));
        ThermoPower3.Water.FlangeA inlet(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-120,-20},{-80,20}},
                rotation=0)));
        ThermoPower3.Water.FlangeB outlet(redeclare package Medium =
              FluidMedium) annotation (Placement(transformation(extent={{80,-20},
                  {120,20}}, rotation=0)));
    ...
    package Examples "Example implementations"
      ...
      model HEG_2L "Heat Exchangers Group with two pressure level"
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.HEG_2L;
        ...
        replaceable Components.HE2ph Ev_LP(
          ...
          rhomcm=rhomcm,
          lambda=lambda,
          FFtype_F=ThermoPower3.Choices.Flow1D.FFtypes.NoFriction,
      ...
      model HEG_2LRh "Heat Exchangers Group with two pressure level and reheat"
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.HEG_2LRh(
        ...
        replaceable Components.ParHE Sh1HP_Rh1IP(
          ...
          FluidPhaseStart_A=ThermoPower3.Choices.FluidPhase.FluidPhases.Steam,
          FluidPhaseStart_B=ThermoPower3.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh1_HP_Tstartbar) constrainedby
          ThermoPower3.PowerPlants.HRSG.Interfaces.ParallelHE(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          gasNomFlowRate=gasNomFlowRate,
          gasNomPressure=gasNomPressure,
      ...
      model HEG_3LRh
        ...
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.HEG_3LRh(
        ...
        replaceable Components.HE Ec2_HP(
          ...
          ThermoPower3.PowerPlants.HRSG.Interfaces.HeatExchanger(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Ec2_HP_N_G,
          N_F=Ec2_HP_N_F,
        ...
        replaceable Components.HE Sh_LP(
          ...
          Tstartbar_G=Sh_LP_Tstartbar,
          FluidPhaseStart=ThermoPower3.Choices.FluidPhase.FluidPhases.Steam)
          constrainedby ThermoPower3.PowerPlants.HRSG.Interfaces.HeatExchanger(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Sh_LP_N_G,
          N_F=Sh_LP_N_F,
      ...
      model HEG_3LRh_des
        ...
        replaceable Components.ParHE_Des ShHP_RhIP(
          ...
          SSInit=SSInit,
          FluidPhaseStart_A=ThermoPower3.Choices.FluidPhase.FluidPhases.Liquid,
          FluidPhaseStart_B=ThermoPower3.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G_p1=Sh2_HP_Tstartbar,
          Tstartbar_G_p2=Sh1_HP_Tstartbar) constrainedby
          ThermoPower3.PowerPlants.HRSG.Interfaces.ParallelHE_Des(
          Cv_valA=Cv_attShHP,
          pnom_valA=pnom_attShHP,
          dpnom_valA=dpnom_attShHP,
          wnom_valA=wnom_attShHP,
      ...
      model DG_2L_NC
        ...
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.DG_2L;
      ...
      model DG_3L_CC
        ...
        extends ThermoPower3.PowerPlants.HRSG.Interfaces.DG_3L_p;
      ...
      model TestHEG_3LRh
        ...
        Water.SourceP sourceShLP(p0=fluidLPNomPressure_Sh, h=Sh_LP_hstart_F_In)
          annotation (Placement(transformation(
              ...
              extent={{6,-6},{-6,6}},
              rotation=90)));
        ThermoPower3.PowerPlants.HRSG.Components.StateReader_gas stateGas_out(
      ...
      public
        Modelica.Blocks.Sources.Ramp n_pump(
          ...
          height=0) annotation (Placement(transformation(extent={{64,34},{52,46}},
                rotation=0)));
        ThermoPower3.PowerPlants.Control.PID pIDController(
          CSmin=500,
          PVmin=-1,
          PVmax=1,
          CSmax=2500,
      ...
      model TestHRSG_wac
        ...
        Water.SourceP sourceShLP(
          ...
          h=1.43495e5) annotation (Placement(transformation(
              ...
              extent={{-6,6},{6,-6}},
              rotation=180)));
        ThermoPower3.PowerPlants.HRSG.Control.levelsControl
  ...
  package SteamTurbineGroup
    ...
    package Components "Component definitions"
      ...
      model CondenserPreP_tap
        ...
        replaceable package Medium = ThermoPower3.Water.StandardWater
          constrainedby Modelica.Media.Interfaces.PartialTwoPhaseMedium;
        parameter SI.Pressure p "Nominal inlet pressure";
        parameter SI.Volume Vtot=10 "Total volume of the fluid side";
        parameter SI.Volume Vlstart=0.15*Vtot;
...
<li><i>1 Oct 2003</i>
    ...
    package Examples "Example implementations"
      ...
      model ST3L_base "Steam turbine with three pressure levels"
        extends ThermoPower3.PowerPlants.SteamTurbineGroup.Interfaces.ST_3L;
      ...
      public
        Modelica.Blocks.Sources.Ramp com_valveHP(
          ...
          startTime=1000) annotation (Placement(transformation(extent={{20,70},
                  {0,90}}, rotation=0)));
        ThermoPower3.PowerPlants.SteamTurbineGroup.Components.PrescribedSpeed
      ...
      model TestCondenserControl
        ...
        Modelica.Blocks.Sources.Ramp const(
          ...
          startTime=1000)
                  ...
                  -54}}, rotation=0)));
        ThermoPower3.PowerPlants.SteamTurbineGroup.Components.CondenserPreP_tap
        ...
        Water.SourceW sourceTap(
          ...
          p0=5389.2)              annotation (Placement(transformation(extent={
  ...
  package ElectricGeneratorGroup
    ...
    package Examples "Example implementations"
      model SingleShaft_static
        ...
        extends
          ThermoPower3.PowerPlants.ElectricGeneratorGroup.Interfaces.SingleShaft;
        ...
        Electrical.Generator generator(eta=eta, initOpt=if SSInit then
              ThermoPower3.Choices.Init.Options.steadyState else ThermoPower3.Choices.Init.Options.noInit)
      ...
      model DoubleShaft_static
        ...
        extends
          ThermoPower3.PowerPlants.ElectricGeneratorGroup.Interfaces.DoubleShaft;
        ...
        ThermoPower3.PowerPlants.ElectricGeneratorGroup.Components.Grid_2in
          grid(Pn=Pn, fn=fn) annotation (Placement(transformation(extent={{140,
                  0},{180,40}}, rotation=0)));
      equation
      ...
      model TripleShaft_static
        ...
        extends
          ThermoPower3.PowerPlants.ElectricGeneratorGroup.Interfaces.TripleShaft;
        Electrical.Generator generator_A(eta=eta_A, initOpt=if SSInit then
              ThermoPower3.Choices.Init.Options.steadyState else ThermoPower3.Choices.Init.Options.noInit)
      ...
      model GeneratorGroup
        ...
        ThermoPower3.Electrical.PowerSensor powerSensor annotation (Placement(
              transformation(extent={{20,-10},{40,10}}, rotation=0)));
        ThermoPower3.Electrical.FrequencySensor frequencySensor annotation (
            Placement(transformation(extent={{20,40},{40,60}}, rotation=0)));
        ThermoPower3.Electrical.Generator generator(
          eta=eta,
          J=J_shaft,
          initOpt=if SSInit then ThermoPower3.Choices.Init.Options.steadyState
      ...
      package OldSwingEquation
        model SingleShaft_SE
          ...
          ThermoPower3.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE
            generator_SE(
            eta=eta,
            Pmax=Pmax,
            J=J_shaft,
    ...
    package Tests "Test cases"
      ...
      public
        ...
        Modelica.Blocks.Math.Add add annotation (Placement(transformation(
              ...
              extent={{-7,-7},{7,7}},
              rotation=180)));
        ThermoPower3.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE_com
          generator_SE(
          J=7000,
          delta_start=0.77,
          Pmax=20e6,
      ...
      public
        ...
        Modelica.Blocks.Math.Add add annotation (Placement(transformation(
              ...
              extent={{-7,-7},{7,7}},
              rotation=180)));
        ThermoPower3.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE_Breaker
          generator_SE(
          Pmax=30e6,
          omega_nom=157.08,
          eta=0.96,
      ...
      model TestSingleShaft
        ...
        ThermoPower3.PowerPlants.ElectricGeneratorGroup.Examples.SingleShaft_static
          ...
          J_shaft=100,
          d_shaft=0,
          SSInit=false) annotation (Placement(transformation(extent={{0,-40},{
                  80,40}}, rotation=0)));
        Water.SteamTurbineStodola steamTurbineStodola(
          wstart=67.6,
          wnom=67.6,
      ...
      public
        Modelica.Blocks.Sources.BooleanConstant booleanConstant(k=true)
          annotation (Placement(transformation(extent={{20,-70},{40,-50}},
                rotation=0)));
        ThermoPower3.PowerPlants.ElectricGeneratorGroup.Examples.DoubleShaft_static
          doubleShaft(
          Pn=50e8,
          J_shaft_A=2000,
      ...
      HRSG.Examples.HRSG_3LRh hRSG(
        ...
        HeatExchangersGroup(
          ...
          Sh1HP_Rh1IP(
            ...
            gamma_F_A=4000,
            gamma_F_B=4000,
            FFtype_F_B=ThermoPower3.Choices.Flow1D.FFtypes.Kfnom,
            Kfnom_F_B=150,
            dpnom_F_B=0.3e5),
          Sh2HP_Rh2IP(
            gamma_G_A=83.97,
...
<li><i>15 Apr 2008</i>
    ...
    public
      ThermoPower3.PowerPlants.GasTurbine.Examples.GasTurbineSimplified
