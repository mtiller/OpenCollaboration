  ...
  package CISE "CISE plant models"
    ...
    model CISEPlant "Model of the CISE lab steam generator"
      ...
      Water.Flow1D2ph Pipe2Drum(
        ...
        hstartin=1.6e6,
        hstartout=1.6e6,
        initOpt=ThermoPower3.Choices.Init.Options.steadyStateNoP,
        FFtype=ThermoPower3.Choices.Flow1D.FFtypes.Cfnom,
        HydraulicCapacitance=ThermoPower3.Choices.Flow1D.HCtypes.Upstream,
        dpnom=17000,
        pstart=6000000) annotation (Placement(transformation(
            origin={-19,-17},
            extent={{-15,15},{15,-15}},
  ...
  package HRB "Heat recovery boiler models"
    ...
    model HeatExchanger "Base class for heat exchanger fluid - gas"
      ...
      Thermal.MetalTube TubeWalls(
        ...
        Tstart1=300,
        TstartN=340,
        initOpt=ThermoPower3.Choices.Init.Options.steadyState) "Tube"
...
Very simple plant model, providing boundary conditions to the <tt>HRB</tt> model.
        ...
        Icon(coordinateSystem(
            ...
            initialScale=0.1), graphics={Rectangle(
                  ...
                  lineColor={0,0,255},
                  lineThickness=0.5,
                  textString="TGin"),Text(
                  extent={{112,110},{150,88}},
                  lineColor={0,0,255},
                  lineThickness=0.5,
                  textString="TGout"),Text(
                  extent={{110,-90},{140,-110}},
                  lineColor={0,0,255},
                  lineThickness=0.5,
                  textString="TWin"),Text(
...
Casella</a>:<br>
    ...
    initial equation
      ...
      annotation (
        Icon(graphics={Text(extent={{-56,36},{16,-34}}, textString="SP"),Text(
              extent={{-58,-38},{14,-108}}, textString="PV"),Text(extent={{62,-16},
              {134,-86}}, textString="CS"),Text(extent={{28,86},{104,24}},
              textString="MANp"),Text(extent={{-56,86},{20,24}}, textString=
              "TRKp"),Text(extent={{-88,104},{-50,70}}, textString="TRK"),Text(
              extent={{-88,66},{-50,32}}, textString="MAN")}),
        Diagram(graphics),
        Documentation(info="<html>
...
<li><i>10 Dec 2008</i>
    ...
    model Evaporator
      ...
      Water.Drum2States water(
        ...
        annotation (Placement(transformation(extent={{-20,26},{20,66}},
              rotation=0)));
      ThermoPower3.Thermal.HT_DHT adapter(N=N, exchangeSurface=exchSurface)
        annotation (Placement(transformation(
            origin={0,0},
            extent={{-10,-10},{10,10}},
            rotation=270)));
    ...
    model PrescribedSpeedPump "Prescribed speed pump"
      ...
      function flowCharacteristic =
          ThermoPower3.Functions.PumpCharacteristics.quadraticFlow (q_nom=q_nom,
            head_nom=head_nom);
...
<li><i>10 Dec 2008</i>
    ...
    model Plant
      import ThermoPower3;
      replaceable package FlueGas = ThermoPower3.Media.FlueGas constrainedby
        Modelica.Media.Interfaces.PartialMedium "Flue gas model";
      replaceable package Water = ThermoPower3.Water.StandardWater
        constrainedby Modelica.Media.Interfaces.PartialPureSubstance
        "Fluid model";
      parameter Boolean SSInit=false "Steady-state initialization";
      ThermoPower3.Examples.RankineCycle.PrescribedPressureCondenser condenser(
          p=5390, redeclare package Medium = Water) annotation (Placement(
            transformation(extent={{100,-100},{140,-60}}, rotation=0)));
      ThermoPower3.Examples.RankineCycle.PrescribedSpeedPump
        prescribedSpeedPump(
        n0=1500,
      ...
      Electrical.NetworkGrid_Pmax network(
        ...
        annotation (Placement(transformation(extent={{240,34},{272,66}},
              rotation=0)));
      ThermoPower3.Water.SteamTurbineStodola steamTurbine(
        wstart=55,
        wnom=55,
        Kt=0.0104,
      ...
      Modelica.Mechanics.Rotational.Sensors.PowerSensor powerSensor1
        annotation (Placement(transformation(extent={{146,60},{166,40}},
              rotation=0)));
      ThermoPower3.Examples.RankineCycle.HE economizer(
        redeclare package FluidMedium = Water,
        ...
        Tstart_G=473.15,
        Tstart_M=423.15,
        FFtype_G=ThermoPower3.Choices.Flow1D.FFtypes.OpPoint,
        dpnom_G=1000,
        FFtype_F=ThermoPower3.Choices.Flow1D.FFtypes.Kfnom,
        dpnom_F=20000) annotation (Placement(transformation(extent={{-120,-80},
                {-80,-120}}, rotation=0)));
      ThermoPower3.Examples.RankineCycle.Evaporator evaporator(
        redeclare package FluidMedium = Water,
        redeclare package FlueGasMedium = FlueGas,
        gasVol=10,
        fluidVol=12.400,
        ...
        rhonom_G=1) annotation (Placement(transformation(extent={{-120,0},{-80,
                -40}}, rotation=0)));
      ThermoPower3.Examples.RankineCycle.HE superheater(
        redeclare package FluidMedium = Water,
        redeclare package FlueGasMedium = FlueGas,
        N_G=3,
        N_F=7,
        ...
        dpnom_F=20000) annotation (Placement(transformation(extent={{-120,80},{
                -80,40}}, rotation=0)));
      ThermoPower3.PowerPlants.HRSG.Components.StateReader_gas stateGasInlet(
      ...
      ThermoPower3.PowerPlants.HRSG.Components.StateReader_gas stateGasOutlet(
          redeclare package Medium = FlueGas) annotation (Placement(
            transformation(extent={{-70,-110},{-50,-90}}, rotation=0)));
      ThermoPower3.PowerPlants.HRSG.Components.StateReader_water
      ...
      ThermoPower3.Gas.SinkP sinkP_gas(T=400, redeclare package Medium =
            FlueGas) annotation (Placement(transformation(extent={{-40,-110},{-20,
                -90}}, rotation=0)));
    equation
...
This is a simple model of a steam plant.
    ...
    package Simulators "Simulation models for the Rankine cycle example"
      ...
      model ClosedLoop
        package FlueGas = ThermoPower3.Media.FlueGas "Flue gas model";
        package Water = ThermoPower3.Water.StandardWater "Fluid model";
        Modelica.Blocks.Sources.Ramp gasFlowRate(
          height=0,
          duration=0,
          offset=750) annotation (Placement(transformation(extent={{-80,10},{-60,
                  30}}, rotation=0)));
        ThermoPower3.Examples.RankineCycle.Plant plant(
...
<li><i>10 Dec 2008</i>
  ...
  package BraytonCycle "Gas power plant"
    ...
    public
      Electrical.Generator generator(J=30000, initOpt=ThermoPower3.Choices.Init.Options.steadyState)
