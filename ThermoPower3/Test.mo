within ThermoPower3;
package Test "Test cases for the ThermoPower3 models"
  ...
  package WaterElements "Test for Water package elements except Flow1D models"
    model TestMixer
      ...
      Water.Mixer mixer(
        ...
        pstart=101325) annotation (Placement(transformation(extent={{-52,20},{-32,
                40}}, rotation=0)));
      ...
      Water.PressDrop pressDrop(
        ...
        rhonom=1000,
        redeclare package Medium = Medium,
        FFtype=ThermoPower3.Choices.PressDrop.FFtypes.OpPoint) annotation (
      ...
      Water.Header header(
        ...
        initOpt=ThermoPower3.Choices.Init.Options.steadyState,
        FluidPhaseStart=ThermoPower3.Choices.FluidPhase.FluidPhases.Steam,
        pstart=101325) annotation (Placement(transformation(extent={{-40,-40},{
                -20,-20}}, rotation=0)));
...
Casella</a>:<br>
    ...
    model TestMixerSlowFast_v2
      ...
      Water.Mixer Mixer1(
        ...
        redeclare package Medium = Medium,
        initOpt=ThermoPower3.Choices.Init.Options.steadyState,
        pstart=101325) annotation (Placement(transformation(extent={{-60,-10},{
                -40,10}}, rotation=0)));
      Water.ValveLin ValveLin1(Kv=1/1e5, redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{38,-10},{58,10}},
              rotation=0)));
      ...
      Water.Header Header1(
        ...
        redeclare package Medium = Medium,
        initOpt=ThermoPower3.Choices.Init.Options.steadyState,
        pstart=101325) annotation (Placement(transformation(extent={{0,-10},{20,
                10}}, rotation=0)));
      Modelica.Blocks.Sources.Step StepEnthalpy(
        height=1e5,
        offset=1e5,
...
Casella</a>:<br>
    ...
    model TestPressDrop
      ...
      Water.PressDrop PressDrop4a(
        ...
        A=1e-4,
        wnom=1,
        FFtype=ThermoPower3.Choices.PressDrop.FFtypes.Kinetic,
      ...
      Water.PressDrop PressDrop2a(
        ...
        wnom=1,
        Kf=Kf_unknown,
        FFtype=ThermoPower3.Choices.PressDrop.FFtypes.Kf,
...
<ul>
    ...
    model TestPressDropRev
      ...
      ThermoPower3.Water.SinkP sinkP(p0=300000)
...
Casella</a>:<br>
    ...
    model TwoTanks "Test case for Tank and Flow1D"
      ...
      Water.Flow1Dfem Pipe(
        ...
        alpha=1,
        dpnom=20,
        initOpt=ThermoPower3.Choices.Init.Options.steadyStateNoP) annotation (
      ...
      ThermoPower3.Water.SourceW Plug1(w0=0) annotation (Placement(
            transformation(extent={{-100,-10},{-80,10}}, rotation=0)));
      ThermoPower3.Water.SinkW Plug2(w0=0) annotation (Placement(transformation(
...
Casella</a>:<br>
    ...
    model TestValves "Test cases for valves"
      ...
      ThermoPower3.Water.SourceP SourceP1(p0=10e5) annotation (Placement(
            transformation(extent={{-100,40},{-80,60}}, rotation=0)));
      ThermoPower3.Water.SourceP SourceP2(p0=8e5) annotation (Placement(
            transformation(extent={{-100,-60},{-80,-40}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP1(p0=1e5) annotation (Placement(
            transformation(extent={{70,-10},{90,10}}, rotation=0)));
      ThermoPower3.Water.ValveLiq V1(
        dpnom=9e5,
        wnom=1.5,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        pnom=10e5,
        Kv=2,
        CvData=ThermoPower3.Choices.Valve.CvTypes.Kv) annotation (Placement(
      ...
      Water.ValveLiq V2(
        ...
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        Av=5e-5,
        CvData=ThermoPower3.Choices.Valve.CvTypes.Av) annotation (Placement(
            transformation(extent={{-30,20},{-10,40}}, rotation=0)));
      ThermoPower3.Water.ValveLiq V3(
        dpnom=3e5,
        wnom=1.1,
        pnom=10e5,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
      ...
      ThermoPower3.Water.ValveLiq V4(
        dpnom=8e5,
        wnom=1.3,
        pnom=10e5,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        Cv=2,
        CvData=ThermoPower3.Choices.Valve.CvTypes.Cv) annotation (Placement(
            transformation(extent={{-30,-80},{-10,-60}}, rotation=0)));
      ThermoPower3.Water.ValveLiq V5(
        dpnom=4e5,
        wnom=2,
        pnom=5e5,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
      ...
      ThermoPower3.Water.SinkP SinkP2(p0=1e5) annotation (Placement(
            transformation(extent={{10,60},{30,80}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP3(p0=1e5) annotation (Placement(
...
Casella</a>:<br>
    ...
    model TestValveChoked "Test case for valves in choked flow"
      ...
      ThermoPower3.Water.SourceP SourceP1(p0=5e5, h=400e3) annotation (
          Placement(transformation(extent={{-50,30},{-30,50}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP1 annotation (Placement(transformation(
      ...
      ThermoPower3.Water.ValveLiqChoked ValveLiqChocked(
        dpnom=2e5,
        wnom=1,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        Av=5e-5,
      ...
      Modelica.Blocks.Sources.Sine Sine1(
        ...
        startTime=1) annotation (Placement(transformation(extent={{10,60},{30,
                80}}, rotation=0)));
      ThermoPower3.Water.SourceP SourceP2(p0=60e5, h=2.9e6) annotation (
          Placement(transformation(extent={{-50,-50},{-30,-30}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP2(p0=1e5) annotation (Placement(
            transformation(extent={{40,-50},{60,-30}}, rotation=0)));
      ThermoPower3.Water.ValveVap ValveVap(
        dpnom=30e5,
        pnom=60e5,
        wnom=1,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
...
Casella</a>:<br>
    ...
    model TestCoeffValve "Test case for valve with the several coefficients"
      ...
      ThermoPower3.Water.SourceP SourceP1(p0=5e5, h=2e5) annotation (Placement(
            transformation(extent={{-50,50},{-30,70}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP1(p0=3e5) annotation (Placement(
      ...
      Water.ValveLiq ValveLiq1(
        ...
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        pnom=5e5,
        CvData=ThermoPower3.Choices.Valve.CvTypes.Av,
        Av=7.2e-5) annotation (Placement(transformation(extent={{-10,50},{10,70}},
              rotation=0)));
      ThermoPower3.Water.SourceP SourceP2(p0=5e5, h=2e5) annotation (Placement(
            transformation(extent={{-50,10},{-30,30}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP2(p0=3e5) annotation (Placement(
      ...
      Water.ValveLiq ValveLiq2(
        ...
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        pnom=5e5,
        CvData=ThermoPower3.Choices.Valve.CvTypes.Kv,
        Kv=2.592) annotation (Placement(transformation(extent={{-10,10},{10,30}},
              rotation=0)));
      ThermoPower3.Water.SourceP SourceP3(p0=5e5, h=2e5) annotation (Placement(
            transformation(extent={{-50,-30},{-30,-10}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP3(p0=3e5) annotation (Placement(
      ...
      Water.ValveLiq ValveLiq3(
        ...
        Cv=2.997) annotation (Placement(transformation(extent={{-10,-30},{10,-10}},
              rotation=0)));
      ThermoPower3.Water.SourceP SourceP4(p0=5e5, h=2e5) annotation (Placement(
            transformation(extent={{-50,-70},{-30,-50}}, rotation=0)));
      ThermoPower3.Water.SinkP SinkP4(p0=3e5) annotation (Placement(
            transformation(extent={{40,-70},{60,-50}}, rotation=0)));
      Water.ValveLiq ValveLiq4(
        dpnom=2e5,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        pnom=5e5,
        CvData=ThermoPower3.Choices.Valve.CvTypes.OpPoint,
        wnom=1.012,
...
<li><i>3 Dec 2008</i>
    ...
    model ValveZeroFlow "Test case for valves with zero flowrate"
      ...
      ThermoPower3.Water.SourceP Source(p0=5e5) annotation (Placement(
            transformation(extent={{-90,-10},{-70,10}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(p0=1e5) annotation (Placement(
            transformation(extent={{70,-10},{90,10}}, rotation=0)));
      ThermoPower3.Water.ValveLiq V1(
        dpnom=2e5,
        wnom=1,
        ...
        pnom=5e5,
        Av=1e-4,
        CvData=ThermoPower3.Choices.Valve.CvTypes.OpPoint) annotation (
          Placement(transformation(extent={{-50,-10},{-30,10}}, rotation=0)));
      ThermoPower3.Water.ValveLiq V2(
        dpnom=1e5,
        wnom=1,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        pnom=3e5,
    ...
    model ValveZeroFlow2 "Test case for valves with zero flowrate"
      ...
      ThermoPower3.Water.Tank Tank2(
        ...
        ystart=0) annotation (Placement(transformation(extent={{30,-14},{50,6}},
              rotation=0)));
      ThermoPower3.Water.ValveLiq Valve(
        dpnom=1e4,
        wnom=10,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        Av=3.5e-3,
      ...
      ThermoPower3.Water.SourceW SourceW1(w0=0) annotation (Placement(
            transformation(extent={{-90,-20},{-70,0}}, rotation=0)));
      ThermoPower3.Water.SinkW SinkW1(w0=0) annotation (Placement(
...
Casella</a>:<br>
    ...
    model TestJoin "Test case FlowJoin and FlowSplit"
      ...
      ThermoPower3.Water.SourceW S1(h=1e5) annotation (Placement(transformation(
              extent={{-58,50},{-38,70}}, rotation=0)));
      ThermoPower3.Water.SourceW S2(h=2e5) annotation (Placement(transformation(
              extent={{-58,10},{-38,30}}, rotation=0)));
      ThermoPower3.Water.SinkW S5(h=2e5) annotation (Placement(transformation(
              extent={{60,-44},{80,-24}}, rotation=0)));
      ThermoPower3.Water.SinkW S6(h=3e5) annotation (Placement(transformation(
              extent={{60,-96},{80,-76}}, rotation=0)));
      ThermoPower3.Water.FlowJoin FlowJoin1 annotation (Placement(
            transformation(extent={{-10,30},{10,50}}, rotation=0)));
      ThermoPower3.Water.FlowSplit FlowSplit1 annotation (Placement(
            transformation(extent={{-4,-70},{16,-50}}, rotation=0)));
      ThermoPower3.Water.SinkP S3(h=3e5) annotation (Placement(transformation(
              extent={{70,30},{90,50}}, rotation=0)));
      ThermoPower3.Water.PressDropLin LossP1(R=1e-5) annotation (Placement(
            transformation(extent={{40,30},{60,50}}, rotation=0)));
      ThermoPower3.Water.PressDropLin LossP2(R=1e-5) annotation (Placement(
            transformation(extent={{-60,-70},{-40,-50}}, rotation=0)));
      ThermoPower3.Water.SourceP S4(h=1e5) annotation (Placement(transformation(
      ...
      Modelica.Blocks.Sources.Sine Sine2(
        ...
        startTime=0) annotation (Placement(transformation(extent={{-90,30},{-70,
                50}}, rotation=0)));
      ThermoPower3.Water.SensT T1(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{-32,54},{-12,74}},
              rotation=0)));
      ThermoPower3.Water.SensT T2(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{-32,14},{-12,34}},
              rotation=0)));
      ThermoPower3.Water.SensT T3(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{14,34},{34,54}}, rotation=
               0)));
      ThermoPower3.Water.SensT T4(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{-30,-66},{-10,-46}},
              rotation=0)));
      ThermoPower3.Water.SensT T5(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{20,-40},{40,-20}},
              rotation=0)));
      ThermoPower3.Water.SensT T6(redeclare package Medium = Medium)
      ...
      Modelica.Blocks.Sources.Sine Sine4(
        ...
        startTime=0) annotation (Placement(transformation(extent={{34,-66},{54,
                -46}}, rotation=0)));
      ThermoPower3.Water.SensP P1 annotation (Placement(transformation(extent={
...
Casella</a>:<br>
    ...
    model TestJoinRev "Test case FlowJoin"
      package Medium = Modelica.Media.Water.WaterIF97OnePhase_ph;
      constant Real pi=Modelica.Constants.pi;
      ThermoPower3.Water.SourceW S1(h=1e5, w0=2) annotation (Placement(
      ...
      Modelica.Blocks.Sources.Trapezoid Sine2(
        ...
        amplitude=-1.2) annotation (Placement(transformation(extent={{-90,30},{
                -70,50}}, rotation=0)));
      ThermoPower3.Water.SourceW S4(h=1e5, w0=2) annotation (Placement(
            transformation(extent={{-58,-30},{-38,-10}}, rotation=0)));
      ThermoPower3.Water.SourceW S5(h=2e5) annotation (Placement(transformation(
              extent={{-58,-70},{-38,-50}}, rotation=0)));
      ThermoPower3.Water.FlowJoin FlowJoin2(
        rev_in1=false,
        rev_in2=false,
        rev_out=false) annotation (Placement(transformation(extent={{-10,-50},{
                10,-30}}, rotation=0)));
      ThermoPower3.Water.SinkP S6(h=3e5) annotation (Placement(transformation(
...
<li><i>3 Dec 2008</i>
    ...
    model TestSplitRev "Test case FlowSplit"
      ...
      ThermoPower3.Water.SinkW S6(h=3e5) annotation (Placement(transformation(
              extent={{60,-96},{80,-76}}, rotation=0)));
      ThermoPower3.Water.FlowSplit FlowSplit2(
        rev_in1=false,
        rev_out1=false,
      ...
      Modelica.Blocks.Sources.Trapezoid Sine4(
        ...
        amplitude=-1.2) annotation (Placement(transformation(extent={{40,-70},{
                60,-50}}, rotation=0)));
      ThermoPower3.Water.SinkW S1(h=2e5) annotation (Placement(transformation(
              extent={{60,52},{80,72}}, rotation=0)));
      ThermoPower3.Water.SinkW S2(h=3e5) annotation (Placement(transformation(
              extent={{60,0},{80,20}}, rotation=0)));
      ThermoPower3.Water.FlowSplit FlowSplit1 annotation (Placement(
            transformation(extent={{-4,26},{16,46}}, rotation=0)));
      ThermoPower3.Water.PressDropLin LossP1(R=1e-5) annotation (Placement(
            transformation(extent={{-60,26},{-40,46}}, rotation=0)));
      ThermoPower3.Water.SourceP S3(h=1e5) annotation (Placement(transformation(
              extent={{-90,26},{-70,46}}, rotation=0)));
      ThermoPower3.Water.SensT T1(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{-30,30},{-10,50}},
              rotation=0)));
      ThermoPower3.Water.SensT T2(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{20,56},{40,76}}, rotation=
               0)));
      ThermoPower3.Water.SensT T3(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{20,4},{40,24}}, rotation=
                0)));
      ThermoPower3.Water.SensP P2 annotation (Placement(transformation(extent={
...
<li><i>3 Dec 2008</i>
    ...
    model WaterPump "Test case for WaterPump"
      ...
      ThermoPower3.Water.SourceP Source(p0=1e5, h=1.5e5) annotation (Placement(
            transformation(extent={{-80,-20},{-60,0}}, rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin1(Kv=1e-5) annotation (Placement(
...
*/
      Water.PumpNPSH Pump1(
        ...
        redeclare function flowCharacteristic =
            ThermoPower3.Functions.PumpCharacteristics.quadraticFlow (q_nom={0,
                0.001,0.0015}, head_nom={60,30,0}),
        redeclare function powerCharacteristic =
            ThermoPower3.Functions.PumpCharacteristics.quadraticPower (q_nom={0,
...
Schiavo</a>:<br>
    ...
    model WaterPumps "Test case for WaterPump"
      ...
      ThermoPower3.Water.SourceP Source1(p0=1e5, h=1.5e5) annotation (Placement(
      ...
      Water.PumpNPSH Pump1(
        ...
        n0=1500,
        redeclare function flowCharacteristic =
            ThermoPower3.Functions.PumpCharacteristics.linearFlow (q_nom={0.001,
      ...
      Modelica.Blocks.Sources.Ramp Step1(
        ...
        duration=1) annotation (Placement(transformation(extent={{-20,60},{0,80}},
              rotation=0)));
      ThermoPower3.Water.SourceP Source2(p0=1e5, h=1.5e5) annotation (Placement(
            transformation(extent={{-80,-10},{-60,10}}, rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin2(Kv=1e-5) annotation (Placement(
      ...
      Water.PumpNPSH Pump2(
        ...
        n0=1500,
        redeclare function flowCharacteristic =
            ThermoPower3.Functions.PumpCharacteristics.quadraticFlow (q_nom={
        ...
        dp0=200000) annotation (Placement(transformation(extent={{-40,-12},{-20,
                8}}, rotation=0)));
      ThermoPower3.Water.SourceP Source3(p0=1e5, h=1.5e5) annotation (Placement(
            transformation(extent={{-80,-60},{-60,-40}}, rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin3(Kv=1e-5) annotation (Placement(
      ...
      Water.PumpNPSH Pump3(
        ...
        n0=1500,
        redeclare function flowCharacteristic =
            ThermoPower3.Functions.PumpCharacteristics.polynomialFlow (q_nom={
                0.0005,0.001,0.0015}, head_nom={50,30,0}),
        wstart=0,
        initOpt=ThermoPower3.Choices.Init.Options.steadyState,
        w0=1,
...
<li><i>3 Dec 2008</i>
    ...
    model WaterPumpMech "Test case for WaterPumpMech"
      ...
      Water.PumpMech Pump(
        ...
        wstart=0,
        w0=1,
        dp0=2e5) annotation (Placement(transformation(extent={{-40,-2},{-20,18}},
              rotation=0)));
      ThermoPower3.Water.SourceP Source annotation (Placement(transformation(
              extent={{-80,0},{-60,20}}, rotation=0)));
      ThermoPower3.Water.ValveLin Valve(Kv=1e-5) annotation (Placement(
      ...
      Modelica.Blocks.Sources.Ramp Ramp1(
        ...
        startTime=15) annotation (Placement(transformation(extent={{-20,40},{0,
                60}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(p0=0.8e5) annotation (Placement(
...
Schiavo</a>:<br>
    ...
    model TestAccumulator "Simple test for Water-Gas Accumulator component"
      ...
      ThermoPower3.Water.PressDropLin PressDropLin1(R=1e5) annotation (
...
"));
    ...
    model TestFlow1Da "Test case for Flow1D"
      ...
      Time tau;
      ThermoPower3.Water.SourceW Fluid_Source(
        p0=phex,
        h=hinhex,
        w0=whex) annotation (Placement(transformation(extent={{-78,-10},{-58,10}},
              rotation=0)));
      ThermoPower3.Water.SinkP Fluid_Sink(p0=phex/2) annotation (Placement(
            transformation(extent={{70,-10},{90,10}}, rotation=0)));
      ThermoPower3.Water.ValveLin Valve(Kv=3e-6) annotation (Placement(
            transformation(extent={{10,-10},{30,10}}, rotation=0)));
      Water.Flow1D hex(
        N=Nnodes,
        L=Lhex,
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-20,-10},{0,
                10}}, rotation=0)));
      ThermoPower3.Water.SensT T_in(redeclare package Medium = Medium)
      ...
      ThermoPower3.Water.SensT T_out(redeclare package Medium = Medium)
    ...
    model TestFlow1Db "Test case for Flow1D"
      ...
      Water.Flow1D hex(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-26,-10},{-6,
                10}}, rotation=0)));
      ThermoPower3.Thermal.TempSource1D TempSource(N=Nnodes) annotation (
          Placement(transformation(extent={{-26,40},{-6,60}}, rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin1(Kv=2*whex/phex) annotation (
          Placement(transformation(extent={{10,-10},{30,10}}, rotation=0)));
      ThermoPower3.Water.SourceW FluidSource(
        w0=whex,
        p0=phex,
        h=hs) annotation (Placement(transformation(extent={{-90,-10},{-70,10}},
              rotation=0)));
      ThermoPower3.Water.SinkP FluidSink(p0=phex/2, h=hs) annotation (Placement(
            transformation(extent={{70,-10},{90,10}}, rotation=0)));
      ...
      ThermoPower3.Thermal.ConvHT ConvEx(N=Nnodes, gamma=400) annotation (
...
<ul>
    ...
    model TestFlow1Dd "Test case for Flow1D"
      ...
      Water.Flow1D hex(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-20,-10},{0,
                10}}, rotation=0)));
      ThermoPower3.Water.SourceW MassFlowRateSource(w0=whex, h=hs) annotation (
          Placement(transformation(extent={{-60,-10},{-40,10}}, rotation=0)));
      ThermoPower3.Water.SinkP FluidSink(
        p0=0,
        R=100,
        h=3e6) annotation (Placement(transformation(extent={{70,-10},{90,10}},
              rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin1(Kv=1e-7) annotation (Placement(
    ...
    model TestFlow1De "Test case for Flow1D"
      ...
      Water.Flow1D hexA(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-20,-70},{0,-50}},
              rotation=0)));
      ThermoPower3.Water.SinkP SideA_FluidSink annotation (Placement(
            transformation(extent={{70,-70},{90,-50}}, rotation=0)));
      ThermoPower3.Water.SinkP SideB_FluidSink annotation (Placement(
            transformation(extent={{-80,30},{-100,50}}, rotation=0)));
      ThermoPower3.Water.SourceW SideA_MassFlowRate(w0=whex, p0=3e5)
        annotation (Placement(transformation(extent={{-74,-70},{-54,-50}},
              rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin1(Kv=whex/(2e5)) annotation (
          Placement(transformation(extent={{14,-70},{34,-50}}, rotation=0)));
      ThermoPower3.Water.ValveLin ValveLin2(Kv=whex/(2e5)) annotation (
      ...
      Water.Flow1D hexB(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{0,50},{-20,30}},
              rotation=0)));
      ThermoPower3.Water.SensT SensT_A_in(redeclare package Medium = Medium)
      ...
      ThermoPower3.Water.SensT SensT_B_in(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{30,34},{10,54}}, rotation=
               0)));
      ThermoPower3.Water.SourceW SideB_MassFlowRate(w0=whex, p0=3e5)
      ...
      ThermoPower3.Water.SensT SensT_A_out(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{40,-66},{60,-46}},
              rotation=0)));
      ThermoPower3.Water.SensT SensT_B_out(redeclare package Medium = Medium)
    ...
    model TestFlow1Df "Test case for Flow1D"
      ...
      ThermoPower3.Water.SensT SensT_B_in(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{30,44},{10,64}}, rotation=
               0)));
      ThermoPower3.Water.SourceW SourceW1(w0=whex, p0=3e5) annotation (
...
<ul>
    ...
    model TestFlow1DSlowFast "Test case for Flow1D"
      ...
      ThermoPower3.Water.SinkP Fluid_Sink(p0=phex/2, redeclare package Medium
          = Medium) annotation (Placement(transformation(extent={{70,-10},{90,
                10}}, rotation=0)));
      ThermoPower3.Water.ValveLin Valve(Kv=3e-6, redeclare package Medium =
...
<ul>
    ...
    model TestFlow1DDB "Test case for Flow1D"
      ...
      ThermoPower3.Water.SensT T_out(redeclare package Medium = Medium)
        annotation (Placement(transformation(extent={{40,-6},{60,14}}, rotation=
               0)));
      ThermoPower3.Thermal.ConvHT_htc ConvHTe_htc1(N=Nnodes) annotation (
...
<ul>
    ...
    model TestFlow1DfemC "Test case for Flow1Dfem"
      ...
      ThermoPower3.Water.SinkP SinkP1(h=hs, p0=4*phex) annotation (Placement(
            transformation(extent={{70,-10},{90,10}}, rotation=0)));
    ...
    model TestFlow1DfemE "Test case for Flow1Dfem"
      ...
      ThermoPower3.Water.SourceW SideB_MassFlowRate(w0=whex, p0=3e5)
        annotation (Placement(transformation(extent={{60,40},{40,60}}, rotation=
               0)));
      ThermoPower3.Thermal.ConvHT ConvExCF(N=Nnodes, gamma=400) annotation (
    ...
    model TestFlow1D2phA "Test case for Flow1D2ph"
      ...
      Water.Flow1D2ph hex(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-20,-30},{0,-10}},
              rotation=0)));
      ThermoPower3.Water.ValveLin valve(redeclare package Medium = Medium, Kv=
            0.4/10e5) annotation (Placement(transformation(extent={{20,-30},{40,
                -10}}, rotation=0)));
      ThermoPower3.Thermal.HeatSource1D heatSource(
        N=Nnodes,
        L=Lhex,
        omega=omegahex) annotation (Placement(transformation(extent={{-20,0},{0,
                20}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(redeclare package Medium = Medium, p0=
            100000) annotation (Placement(transformation(extent={{60,-30},{80,-10}},
              rotation=0)));
      ...
      Modelica.Blocks.Sources.Ramp extPower(
        ...
        height=12e5) annotation (Placement(transformation(extent={{-80,26},{-60,
                46}}, rotation=0)));
      ThermoPower3.Water.SourceW Source(redeclare package Medium = Medium, w0=
...
<ul>
    ...
    model TestFlow1D2phB "Test case for Flow1D2ph"
      ...
      ThermoPower3.Thermal.HeatSource1D heatSource(
        ...
        omega=omegahex) annotation (Placement(transformation(extent={{-20,0},{0,
                20}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(p0=1e5, redeclare package Medium = Medium)
    ...
    model TestFlow1D2phC "Test case for Flow1D2ph"
      ...
      ThermoPower3.Thermal.HeatSource1D heatSource(
        ...
        omega=omegahex) annotation (Placement(transformation(extent={{-10,0},{
                10,20}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(redeclare package Medium = Medium, p0=11e5)
        annotation (Placement(transformation(extent={{60,-30},{80,-10}},
              rotation=0)));
      Modelica.Blocks.Sources.Ramp hIn(
        height=1e5,
...
<ul>
    ...
    model CheckFlow1D2phMassBalance
      ...
      package Medium = ThermoPower3.Water.StandardWater;
...
This model checks the dynamic mass balance equations of Flow1D2ph, by prescribing enthalpy and pressure values that will ensure complete coverage of the different cases.
    ...
    model TestFlow1D2phDB "Test case for Flow1D2phDB"
      ...
      Water.Flow1D2phDB hex(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-20,-70},{0,-50}},
              rotation=0)));
      ThermoPower3.Water.ValveLin valve(Kv=0.05/60e5) annotation (Placement(
            transformation(extent={{30,-70},{50,-50}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(p0=0) annotation (Placement(transformation(
      ...
      Modelica.Blocks.Sources.Ramp extTemp1(
        ...
        startTime=100) annotation (Placement(transformation(extent={{-100,20},{
                -80,40}}, rotation=0)));
      ThermoPower3.Water.SourceW Source(
        w0=0.05,
        p0=60e5,
    ...
    model TestFlow1D2phDB_hf "Test case for Flow1D2ph"
      ...
      Water.Flow1D2phDB hex(
        ...
        dpnom=1000) annotation (Placement(transformation(extent={{-30,-50},{-10,
                -30}}, rotation=0)));
      ThermoPower3.Water.ValveLin valve(Kv=0.1/15e5) annotation (Placement(
            transformation(extent={{20,-50},{40,-30}}, rotation=0)));
      ThermoPower3.Thermal.HeatSource1Dhtc heatSource(
        N=Nnodes,
        L=Lhex,
        omega=omegahex) annotation (Placement(transformation(extent={{-30,-28},
                {-10,-8}}, rotation=0)));
      ThermoPower3.Water.SinkP Sink(p0=1e5) annotation (Placement(
            transformation(extent={{60,-50},{80,-30}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp extPower(
        duration=30,
        height=3e5,
        startTime=10) annotation (Placement(transformation(extent={{-80,44},{-60,
                64}}, rotation=0)));
      ThermoPower3.Water.SourceW Source(w0=0.1) annotation (Placement(
...
Algorithm Tolerance = 1e-6 
    ...
    model TestGasFlow1DB
      extends ThermoPower3.Test.ThermoHydraulicElements.TestGasFlow1DA(
...
Same as <tt>TestGasFlow1DA</tt>, but with mixture fluid (CombustionAir) and UniformComposition = true. The inlet composition is changed stepwise at time t = 30;
    ...
    model TestGasFlow1DC
      extends ThermoPower3.Test.ThermoHydraulicElements.TestGasFlow1DB(hex(
    ...
    model TestFlow1DfemG "Test case for Flow1Dfem"
      ...
      ThermoPower3.Water.SourceW Fluid_Source(
        ...
        h=hinhex + deltah) annotation (Placement(transformation(extent={{-76,-10},
                {-56,10}}, rotation=0)));
      ThermoPower3.Water.SinkP Fluid_Sink(p0=phex/2, h=hinhex) annotation (
...
<ul>
    ...
    model TestFlow1DfemH "Test case for Flow1Dfem"
      ...
      ThermoPower3.Water.SinkP sink1(h=hinhex, p0=100000) annotation (Placement(
      ...
      Water.Flow1Dfem pipe1(
        ...
        FFtype=ThermoPower3.Choices.Flow1D.FFtypes.Cfnom,
        initOpt=ThermoPower3.Choices.Init.Options.steadyState,
        HydraulicCapacitance=ThermoPower3.Choices.Flow1D.HCtypes.Middle,
...
<ul>
    ...
    model TestFlow1DfemK "Test case for Flow1Dfem"
      ...
      ThermoPower3.Water.SinkP sink1(p0=phex, h=hhex) annotation (Placement(
            transformation(extent={{66,-10},{86,10}}, rotation=0)));
      Water.Flow1Dfem pipe1(
        N=Nnodes,
        L=Lhex,
    ...
    model TestCC
      ...
      ThermoPower3.Gas.CombustionChamber CombustionChamber1(
        ...
        S=0.1) annotation (Placement(transformation(extent={{-38,-10},{-18,10}},
              rotation=0)));
      ThermoPower3.Gas.SourceW Wfuel(redeclare package Medium =
            ThermoPower3.Media.NaturalGas) annotation (Placement(transformation(
              extent={{-50,28},{-30,48}}, rotation=0)));
      ThermoPower3.Gas.PressDrop PressDrop1(
        ...
        dpnom=0.426e5) annotation (Placement(transformation(extent={{-4,-10},{
                16,10}}, rotation=0)));
      ThermoPower3.Gas.SensT SensT1(redeclare package Medium =
            ThermoPower3.Media.FlueGas) annotation (Placement(transformation(
      ...
      Modelica.Blocks.Sources.Step Step1(
        ...
        offset=3.1) annotation (Placement(transformation(extent={{-78,56},{-58,
                76}}, rotation=0)));
      ThermoPower3.Gas.ValveLin ValveLin1(redeclare package Medium =
            ThermoPower3.Media.FlueGas, Kv=161.1/9.77e5) annotation (Placement(
            transformation(extent={{54,-10},{74,10}}, rotation=0)));
      ThermoPower3.Gas.SinkP SinkP1(redeclare package Medium =
            ThermoPower3.Media.FlueGas) annotation (Placement(transformation(
...
<p>Simulate for 10 s. At time t=1, t=3 and t=6 the valves are partially closed.
    ...
    public
      ThermoPower3.Gas.SourceP SourceP1(
        redeclare package Medium = Medium,
        p0=0.35e5,
        T=244.4) annotation (Placement(transformation(extent={{-80,6},{-60,26}},
              rotation=0)));
      ThermoPower3.Gas.SinkP SinkP1(
        redeclare package Medium = Medium,
        p0=8.3e5,
      ...
      ThermoPower3.Gas.Compressor Compressor(
        ...
        tableEta=tableEta,
        tablePR=tablePR,
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.matrix,
        Ndesign=523.3,
...
<p>Simulate for 5 seconds. 
    ...
    protected
      ...
      parameter Real tableEtaT[5, 4]=[1, 90, 100, 110; 2.36, 89e-2, 89.5e-2,
          ...
          90.5e-2; 4.46, 90.2e-2, 90.3e-2, 90e-2];
    public
      ThermoPower3.Gas.Compressor Compressor1(
        ...
        tablePR=tablePR) annotation (Placement(transformation(extent={{-46,-24},
                {-26,-4}}, rotation=0)));
      ThermoPower3.Gas.TurbineStodola Turbine1(
      ...
      ThermoPower3.Gas.SinkP SinkP1(
        ...
        T=800) annotation (Placement(transformation(extent={{82,-16},{102,4}},
              rotation=0)));
      ThermoPower3.Gas.SourceW SourceW1(
    ...
    public
      ThermoPower3.Gas.Compressor Compressor1(
        ...
        Tdes_in=244.4) annotation (Placement(transformation(extent={{-66,-30},{
                -46,-10}}, rotation=0)));
      ThermoPower3.Gas.Turbine Turbine1(
        redeclare package Medium = Media.FlueGas,
        pstart_in=7.85e5,
        pstart_out=1.52e5,
...
<li>P. P. Walsh, P. Fletcher: <i>Gas Turbine Performance</i>, 2nd ed., Oxford, Blackwell, 2004, pp. 646.
    ...
    model TestGT_ISO
      ...
      ThermoPower3.Gas.GTunit_ISO GT(
        tableData=tableData,
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.matrix,
        pstart=0.9735e5,
        Tstart=285.5,
      ...
      Modelica.Mechanics.Rotational.Sources.ConstantSpeed ConstantSpeed1(
          w_fixed=1819.6, useSupport=false) annotation (Placement(
            transformation(extent={{80,-10},{60,10}}, rotation=0)));
      ThermoPower3.Gas.SourceW SourceW1(
        redeclare package Medium = ThermoPower3.Media.NaturalGas,
        T=291.44,
        p0=13.27e5,
...
<p>Simulate for 2 s. The model start at steady state. At time t = 1, the fuel flow rate is reduced by 30%. The net power output GT.Pout goes from 4.5 MW to 2.7 MW.
    ...
    model TestGT
      ...
      ThermoPower3.Gas.GTunit GTunit(
        pstart=0.999e5,
        HH=42.53e6,
        Tstart=280.55,
        constantCompositionExhaust=true,
...
"));
    ...
    model TestNetworkGridGenerator_Pmax
      ...
      ThermoPower3.Electrical.NetworkGrid_Pmax network(
        J=10000,
        Pmax=20e6,
        hasBreaker=true,
        deltaStart=0.488,
...
<li><i>15 Jul 2008</i>
    ...
    model TestNetworkGridTwoGenerators
      parameter Boolean SSInit=true "Steady-state initialization";
      ThermoPower3.Electrical.NetworkGridTwoGenerators network(
        J_a=10000,
        J_b=10000,
        r_b=0.3,
        v=15000,
...
<li><i>15 Jul 2008</i>
    ...
    model TestN2GControl
      ...
      parameter Boolean SSInit=true "Steady-state initialization";
      ThermoPower3.Electrical.NetworkTwoGenerators_Pmax network(
        J_a=10000,
        J_b=10000,
        r_b=0.3,
        Pmax=20e6,
      ...
      Electrical.Generator generator_b(J=10000, initOpt=if SSInit then Choices.Init.Options.steadyState
            ...
            extent={{-10,-10},{10,10}},
            rotation=180)));
      ThermoPower3.Electrical.Load load_a(Wn=10e6) annotation (Placement(
            transformation(extent={{-30,-90},{-10,-70}}, rotation=0)));
      ThermoPower3.Electrical.Load load_b(Wn=10e6) annotation (Placement(
      ...
      Modelica.Mechanics.Rotational.Sources.Torque torque_b(useSupport=false)
        annotation (Placement(transformation(extent={{86,-70},{66,-50}},
              rotation=0)));
      ThermoPower3.Test.ElectricalElements.StaticController controller_A(droop=
            0.05, CVnom=1e7/157.08) annotation (Placement(transformation(extent=
               {{-40,20},{-60,40}}, rotation=0)));
      ThermoPower3.Test.ElectricalElements.StaticController controller_b(droop=
            0.05, CVnom=1e7/157.08) annotation (Placement(transformation(extent=
               {{40,20},{60,40}}, rotation=0)));
...
<li><i>15 Jul 2008</i>
  ...
  annotation (Documentation(info="<HTML>
This package contains test cases for the ThermoPower3 library.
</HTML>"));
end Test;
