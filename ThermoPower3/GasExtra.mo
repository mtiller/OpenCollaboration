...
package GasExtra
  ...
  model Compressor_low "Gas compressor"
    extends ThermoPower3.Gas.CompressorBase;
    import ThermoPower3.Choices.TurboMachinery.TableTypes;
...
<li><i>22 Apr 2005</i>
  ...
  model Turbine_low "Gas Turbine for low speed"
    extends ThermoPower3.Gas.TurbineBase;
    import ThermoPower3.Choices.TurboMachinery.TableTypes;
    parameter AngularVelocity Ndesign "Design velocity";
    parameter Real tablePhic_low[:, :]=fill(
          0,
...
<li><i>22 Apr 2005</i>
  ...
  package Test
    ...
    model GTprova_ISO
      ...
      ThermoPower3.Gas.GTunit_ISO GTunit1(
        pstart=0.999e5,
        HH=42.53e6,
        Tstart=280.55,
        fileName="D:/mati_nuovo/ThermoPower3/table/tableGTunit_ISO.txt",
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.file) annotation (
...
double tabHI(12,4)   # table for HI_iso=h(ZLPout_iso,Tsync)
    ...
    4.85e6       16.224e6     15.2e6       15.6e6*/
      ThermoPower3.Gas.GTunit GTunit(
        ...
        HH=42.53e6,
        Tstart=280.55,
        fileName="D:/mati_nuovo/ThermoPower3/table/tableGTunit.txt",
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.file) annotation (
...
<p>Simulate for 2 s. The plant starts at steady states, and produces approximately 5 MW of power. At time t=1 the breaker opens, and the GT unit starts accelerating, with a time constant of 10 seconds.
    ...
    model Test_low
      ...
      Compressor_low Compressor11_1(
        ...
        Tstart_in=244.4,
        Tstart_out=691.4,
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.file,
        fileName="D:/mati_nuovo/ThermoPower3/table/Compr_low.txt",
      ...
      Turbine_low Turbine_low1(
        ...
        Tstart_in=691,
        Tstart_out=560,
        fileName="D:/mati_nuovo/ThermoPower3/table/Turb_low.txt",
        Table=ThermoPower3.Choices.TurboMachinery.TableTypes.file,
        pstart_out=2e5,
        pstart_in=7.3e5,
    ...
    model Test_low1
      ...
      ThermoPower3.Gas.Compressor_low Compressor1(
        redeclare package Medium = Medium,
        pstart_in=0.35e5,
        pstart_out=8.3e5,
        Tstart_in=244.4,
    ...
    model GTprova
      ...
      ThermoPower3.Gas.GTunit GTunit1(
        pstart=0.999e5,
        HH=42.53e6,
        Tstart=280.55,
        fileName="D:/mati_nuovo/ThermoPower3/table/tableGTunit.txt",
...
<p>Simulate for 2 seconds. The compressor slows down.
    ...
    model TestCompressor
      package Medium = ThermoPower3.Media.Air;
      ThermoPower3.Gas.SourceP SourceP1(
        redeclare package Medium = Medium,
        T=-20 + 273.15,
...
<p>Simulate for 2 seconds. The compressor slows down.
    ...
    model TestTurbine
      package Medium = ThermoPower3.Media.FlueGas;
    protected
